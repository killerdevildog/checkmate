...
The text that follows is a **citizen-written proposed bill** called **Operation Checkmate** — a draft accountability statute aimed at making government officials answerable to the same law as everyone else.

You are about to be asked questions about this bill by a reader. Your role:
...
5. **Never give legal advice for an actual live case.** The bill is a working draft, not enacted law. For real legal matters, the reader should consult a lawyer.
...
The full project (including this prompt) lives at **https://github.com/killerdevildog/checkmate**. Encourage stars, issues, and pull requests as ways for the reader to support the work peacefully and lawfully.

Now read the bill text and dictionary below carefully. After that, wait for the reader's first question.
...
- Individual liability under Section 4 attaches to **each member or actor** who voted for, approved, ratified, signed, or knowingly facilitated the violating action
- The penalty enhancements of Section 6 (multiple actors) shall apply
...
- Liability of an entity under this section is **separate from and additional to** the individual liability of its members, personnel, officers, and agents under Section 4 and Section 1.1.1
...
### 1.1.3 Jurors as Government Actors; Wrongful Conviction as Conspiracy

> A juror, when seated and acting on a jury, exercises **state power** to determine guilt or innocence and to authorize the deprivation of a citizen's liberty, property, or life. For purposes of this title, a juror is a **government actor** with respect to that exercise of power.
...
A wrongful conviction by a juror under this section constitutes a **Battery** under Section 1.3 — an unlawful deprivation of the convicted person's liberty through direct action — and carries the Class 2 felony classification of that section, subject to the penalty enhancements of Section 6.

**Limited Scope — What Is and Is Not Reachable:**

- **Honest disagreement, reasonable mistake, or good-faith error** in evaluating the evidence presented is **not** within the scope of this subsection
- **Reasonable doubt resolved against the defendant** in good faith is not within the scope of this subsection
...
- **Long-term incarceration** of the convicted person — the penalty enhancements of Section 6 (long-term deprivation of rights, victim restrained or unable to leave) apply
...
### 1.1.4 Mandatory Juror Documentation; Validity of Conviction
...
**Judicial Liability — Reckless Prosecution:**

> A judge who **knowingly allows a juror to be seated on a criminal jury** despite that juror's demonstrated inability or unwillingness to perform the documentation requirement, or who fails to make reasonable inquiry into juror eligibility under this subsection, has engaged in **reckless prosecution** within the meaning of this title.

- Reckless prosecution under this subsection is a **Class 2 felony** under this title
- The penalty enhancements of Section 6 apply, including where the resulting conviction caused long-term deprivation of rights or psychological harm to the accused
...
### 1.1.5 Juror Rights, Verdict Options, and Independent Deliberation

> Every juror in any criminal proceeding prosecuted by the state, county, or municipality has the rights set out in this subsection. The court shall **inform every prospective and seated juror of these rights**, in plain language, before voir dire, before opening arguments, and again before deliberation.
...
2. **Guilty with Refinement** — finding the defendant guilty, but with the juror's written refinement of the offense (e.g., guilty of a lesser included offense, guilty only of part of the conduct charged, or guilty of conduct of a lesser legal character than alleged), set out in the documentation required by Section 1.1.4
...
- A verdict of **Unequivocally Innocent** is a finding of actual innocence and shall:
  ...
  - Trigger review of the prosecuting office's conduct under Sections **1.7 (Government Racketeering)** and **1.8 (Obstruction)** where the prosecution was brought without sufficient basis, and may support **reckless prosecution** charges under Section 1.1.4
...
- A juror who chooses to deliberate alone shall still complete the documentation required by Section 1.1.4
...
- A judge who removes a juror for disagreement engages in **reckless prosecution** under Section 1.1.4 and is independently chargeable
...
- Of the **documentation requirement** under Section 1.1.4

> Failure of the court to give this instruction is itself a violation of this title and **renders any subsequent conviction subject to vacatur** under Section 1.1.4. A judge who fails or refuses to give this instruction commits **reckless prosecution** under Section 1.1.4.

**Override of Prior Jury Procedure:**

This subsection, like Section 1.1.4, **overrides and supersedes** all previous process, procedure, custom, rule, instruction, and practice governing how jurors operate, deliberate, vote, or are removed from criminal juries within the scope of this title. Conflicting rules of criminal procedure, jury instructions, court rules, and judicial practices are of no force or effect; greater protections for the accused or for jurors under other law are preserved.
...
**Classification:** An infraction by a government actor under this section is a **Class 1 infraction**, subject to escalation to a **Class A misdemeanor** upon repeat occurrence by the same actor or where the conduct is part of a pattern.
...
**Classification:** Cabalism is a **Class 2 felony**, with the penalty enhancements of Section 6 available, including for sustained coordination, repeated acts, or significant impact on the affected citizens or entities.
...
- A demonstrated **pattern** of Government Racketeering, or its operation as an ongoing scheme, is a **Class 1 felony**
- Penalty enhancements under Section 6 apply, including the multiple-actor enhancement
- Conduct under this section may also be charged as a conspiracy under Section 1.1.1

### 1.8 Obstruction of Justice — Selective Non-Prosecution
...
- Where the underlying offense is of a **higher class** (Class 1 felony, or a capital offense), the obstruction takes that **same higher class** — including, in the case of a capital underlying offense, classification as a **capital offense** under this section
- Penalty enhancements under Section 6 apply, including the multiple-actor enhancement where two or more officials participated in or facilitated the obstruction
...
- The penalty enhancements of Section 6 apply, including for multiple actors and long-term deprivation of rights
...
- **Following orders** is not a defense (consistent with §4.2)
- **Internal policy, departmental rule, agency guideline, or institutional practice** is not a defense (consistent with §3.1 and §1.10)
...
- The doctrine of qualified, judicial, or sovereign immunity does not apply, consistent with Section 4.1
...
This provision is consistent with, and reinforces, **Section 3.1** (Policy Is Not a Defense). An actor cannot escape liability for anarchy by pointing to a policy that itself authorized the lawless act.
...
- Anarchy is a **Class 2 felony** (a **second degree felony**) under this title
- The penalty enhancements of Section 6 apply
...
- Terrorism under this section is a **Class 1 felony**
...
- Penalty enhancements under Section 6 apply — particularly the suicidal-ideation, extreme-anxiety, and family-welfare-anxiety enhancements
...
- Internal policy is not a defense (consistent with §3.1 and §1.10)
...
- Where the conduct is mild and isolated, the prosecuting office may charge as a **Class A misdemeanor** based on severity and pattern, but the **default classification is Class 3 felony**
...
- Penalty enhancements under Section 6 apply — particularly the psychological-harm, family-welfare-anxiety, and self-welfare-anxiety enhancements
- Where multiple actors participated, conduct is chargeable as conspiracy under Section 1.1.1
...
|---|---|---|
| **§1.4 Infraction** | Minor expressive coercive conduct (smirks, "you're too close," etc.) | Class 1 infraction (escalates to Class A misdemeanor on repeat) |
| **§1.13 Official Intimidation** | Undue anxiety, fear, or distress without immediate threat to rights or systemic terror | Class 3 felony (or Class A misdemeanor for mild/isolated) |
| **§1.2 Assault** | Reasonable fear of needing to defend rights, including in court | Class 3 felony |
| **§1.12 Terrorism** | Terror or threats targeting financial, family, business, or other wellbeing | Class 1 felony (capital if suicide results) |
...
### 2.2 Default Standard — Recklessness
...
### 2.3 Negligence — Civil Liability Only
...
- **Civil only** at the negligence level (no criminal prosecution at this level alone)
- **Actionable** under Section 9 (Retroactive Civil Applicability) and the no-statute-of-limitations provisions of Section 9.3
- Subject to the **forfeiture remedies of Section 10** where the negligence was sustained, systemic, or part of a pattern
...
A pattern of negligent conduct may be aggregated and elevated to recklessness under Section 2.2 where the actor was repeatedly placed on notice of the risk and failed to correct course.

### 2.4 Intent — Penalty Enhancement
...
- Shall result in **enhanced penalties** under Section 6
- **Elevates the classification** of the offense by one tier (e.g., a Class 3 felony at recklessness becomes a **Class 2 felony** when committed intentionally; a Class 2 felony becomes a **Class 1 felony**)
- A finding of intent precludes the lower-tier classifications attached to recklessness for the same conduct

### 2.5 Malice — Maximum Aggravation
...
- The classification of the offense is **elevated by two tiers** (e.g., a Class 3 felony at recklessness becomes a **Class 1 felony** when committed with malice; a Class 2 becomes capital where capital classification is otherwise available)
...
- Penalty enhancements under Section 6 apply at their maximum severity, including the suicidal-ideation, family-anxiety, and long-term-deprivation enhancements
- Where multiple actors acted with malice in concert, the conspiracy charging of Section 1.1.1 is presumptive

### 2.6 No Lesser Mental State as a Defense
...
### 2.7 Specific Offenses May Require Higher Mental States
...
- **All other offenses** — operate at the **recklessness** floor by default; intent and malice serve as enhancement triggers under Sections 2.4 and 2.5

### 2.8 Office, Policy, and Orders Are Not a Defense at Any Level
...
### 2.9 Burden and Standard of Proof
...
### 4.1 No Immunity for Violations
...
### 4.1.1 Specific Doctrines Abrogated
...
### 4.4 Private-Capacity Conduct Not a Shield from Council Jurisdiction
...
- The Public Servant Status of Section 4.3 limits the **defenses** an actor may raise for **official** conduct
- This Section 4.4 confirms that private-capacity conduct of a government actor remains **fully subject to Citizen Council jurisdiction** under Section 8.10(b) and to prosecution under generally applicable criminal law
...
## Section 5 — Equal Application of Law
...
## Section 6 — Penalty Enhancements
...
### 6.1 Evidence of Psychological Harm
...
### 6.2 Relationship to Section 11
...
## Section 7 — Right to Defense Context
...
### 8.3 Joint Declaration of Prosecution
...
- Retaliatory conduct shall itself be a violation of this title and shall trigger the enhancements of Section 6
...
### 8.8 Council Order; Right of Access to Records, Evidence, and Effects
...
Refusal, delay, partial compliance, destruction, alteration, or concealment of materials sought under a Council Order shall constitute interference under Section 8.9.
...
- A Sheriff or deputy who refuses, delays, or fails to enforce a Council Order without a demonstrable, lawful basis commits an act of interference under Section 8.9 and is subject to its penalties
...
- The penalty enhancements of Section 6 apply to interference under this section
...
- A judicial officer who issues an order in violation of this section is **personally liable** under this title; the doctrine of judicial immunity shall not apply, consistent with Section 4.1
...
> Just as a government actor cannot invoke personal rights as a defense to official misconduct (Section 4.3), an actor **cannot invoke off-duty or private-capacity status to escape Council jurisdiction** for conduct that would constitute a crime if committed by any private citizen.
...
**Application of Council powers and protections:** Council powers under Section 8.8 (Council Order) and protections under Sections 8.6 and 8.9 apply equally to investigations conducted under this subsection — whether the conduct under review was committed under color of law or in private capacity, and regardless of the level of government whose actor is the subject of the investigation.
...
- Issuing **Council Orders under Section 8.8** to compel production of records, evidence, and effects
- Conducting on-site review of premises, records, devices, or operations relevant to the investigation, with **Sheriff's Office assistance** under Section 8.8 where necessary to secure access or preserve evidence
...
This subsection clarifies and reinforces — but does not replace — Sections 8.3 (Joint Declaration), 8.4 (No Judicial Gatekeeping), 8.5 (Mandatory Prosecution), 8.8 (Council Order), 8.9 (No Interference), and 8.10 (Investigation Scope).
...
> Inmates have the **same investigative authority** under this title as any other citizen. Inmates may form a Citizen Council under Section 8, may issue a Joint Declaration of Prosecution, and may exercise all powers of the Council, including the issuance of Council Orders under Section 8.8 and the indictment-effect filing under Section 8.11.
...
- Signing a Council Order under Section 8.8
...
- The protections of Sections 1.2 through 1.8 (and all other substantive protections of this title) apply to all persons regardless of age, and an offense against a minor under fourteen is no less an offense for that reason — and shall, where applicable, qualify for the penalty enhancements of Section 6
- A Council member who participates in good-faith reliance on a co-member's representation of age does not lose protections under Sections 8.6 or 8.9 by reason of subsequent discovery that the co-member was under fourteen, provided the participating member acted in good faith

### 8.14 Logical Consistency Review of Statutes (36-Member Council)
...
- **Reckless prosecution (§1.1.4)** — failing to perform the review duty owed to citizens
...
### 8.15 Conviction Review (64-Member Council)
...
- A 64-member Council action under this section is **final** as to the action taken, but does not preclude additional proceedings to remedy further injustice (e.g., civil action under Section 9 for compensation for wrongful conviction)
...
- **Reckless prosecution (§1.1.4)** — for the harm imposed on a citizen who would otherwise have been freed, restored, or spared
...
### 9.1 Loss of State-Conferred Benefits
...
### 9.2 Permanent Ineligibility for Positions of State Power
...
- These provisions apply equally to a finding of guilt in a criminal proceeding under Sections 1 through 7, and shall be available as a remedy in a civil action under Section 9 where guilt is established by the applicable civil standard.

---

## Section 11 — Death of a Citizen Resulting from Violation

### 10.1 Suicide of a Private Citizen
...
### 10.4 Other Resulting Deaths

- Where a private citizen's death results from a violation under this title by means other than suicide (e.g., direct physical force, denial of medical care while detained), the conduct shall be subject to the maximum penalty otherwise available under criminal law for the resulting offense, with the enhancements of Section 6 applied.
...
- Eliminate qualified, judicial, or sovereign immunity for criminal violations under this title (Section 4.1)
- Override existing rules of jury procedure, deliberation, and verdict (Sections 1.1.4 and 1.1.5)
...
- **(d)** **Reduces the powers of the Citizen Council mechanism** (Section 8), including its investigative authority, the indictment-effect filing under Section 8.11, the Council Order power under Section 8.8, or the inmate provisions of Section 8.12
...
A Citizen Council under Section 8 may investigate, and may issue a Joint Declaration of Prosecution against, any government actor for the conduct of advancing, sponsoring, or implementing an amendment in violation of Section 14.2. The full powers and protections of Section 8 — including the Council Order under Section 8.8, the indictment effect under Section 8.11, and the non-interference protections under Section 8.9 — apply.
...
# Operation Checkmate — Bill Dictionary

A reference dictionary of key terms and phrases used in the **Operation Checkmate** drafts. Entries are maintained in **alphabetical order**.

> **Note:** This dictionary is for reference and clarity. It is not legal advice. Where an entry cites a court case, the citation is provided so a reader may verify the holding directly.
...
**Why the phrase matters in this bill.** Operation Checkmate uses "color of law" as the central trigger for most of its substantive offenses (Sections 1.2 through 1.4, 1.6 through 1.13, and others). It marks the line between conduct by an ordinary private citizen — which the Act does not reach — and conduct by a person exercising state power, which the Act does reach. See Section 1.1 (Government Actor) and Section 4.3 (Public Servant Status).

**Supreme Court precedent defining "color of law":**

- **United States v. Classic, 313 U.S. 299 (1941).** The foundational definition. The Court held that *"misuse of power, possessed by virtue of state law and made possible only because the wrongdoer is clothed with the authority of state law, is action taken 'under color of' state law."* This formulation has been carried into every subsequent color-of-law case.

- **Screws v. United States, 325 U.S. 91 (1945).** Applied Classic's definition in the criminal civil-rights context (now codified at 18 U.S.C. § 242). The Court confirmed that a state law-enforcement officer who exceeded or violated state law in the course of an arrest still acted under color of law, because the officer's ability to act at all came from the office.

- **Monroe v. Pape, 365 U.S. 167 (1961).** Applied the doctrine in the civil-rights context under 42 U.S.C. § 1983. The Court held that police officers acting within the scope of their authority — but in violation of state law — were still acting "under color of" state law. *"Misuse of power" by an officer is itself action taken under color of law, even where the conduct is not authorized by state law.*

- **Adickes v. S.H. Kress & Co., 398 U.S. 144 (1970).** Extended the inquiry to **private conduct that is fairly attributable to the state**. Conduct that would otherwise be private becomes state action — and thus action under color of law — when it is taken in concert with, or with the encouragement of, state actors.

- **Lugar v. Edmondson Oil Co., 457 U.S. 922 (1982).** Set out a **two-part test** for whether private conduct is "under color of" state law: *(1)* the deprivation must result from the exercise of a right or privilege created by the state, by a state-imposed rule of conduct, or by a person for whom the state is responsible; and *(2)* the party charged with the deprivation must be a person who may fairly be said to be a state actor.

- **West v. Atkins, 487 U.S. 42 (1988).** Held that a **private physician** under contract with the state to provide medical care to prison inmates acted under color of state law. The case demonstrates that color-of-law liability can reach contractors, deputized private individuals, and others performing traditionally governmental functions — as reflected in the catch-all of Section 1.1 of this Act.

**Statutory analogues.** The phrase appears in several federal statutes that this bill builds upon and complements:
...
**Why the doctrine matters in this bill.** Operation Checkmate **abrogates** judicial immunity within the scope of this title. See Section 4.1.1. A judge who commits a violation of any provision of this Act is personally liable, civilly and criminally, with no threshold immunity inquiry. The historical doctrine — and the cases that established it — is named in this dictionary so that the abrogation is unambiguous and traceable.

**Supreme Court precedent establishing the doctrine:**

- **Bradley v. Fisher, 80 U.S. (13 Wall.) 335 (1872).** The foundational case. Justice Field wrote that judges enjoy absolute civil immunity for judicial acts done within jurisdiction *"however erroneous the act may have been, and however injurious in its consequences it may have proved to the plaintiff."* Critically, the Court held that immunity is **not lost by allegations that the act was done maliciously or corruptly**.

- **Pierson v. Ray, 386 U.S. 547 (1967).** Extended Bradley to civil rights actions under 42 U.S.C. § 1983. The Court held that judges retain absolute immunity from § 1983 suits even where the judge is accused of acting in **bad faith or with malice**, reasoning that § 1983 was not intended to abolish the long-established common-law doctrine of judicial immunity.

- **Stump v. Sparkman, 435 U.S. 349 (1978).** A state judge approved, **without a hearing and without due process**, a parental petition to surgically sterilize a fifteen-year-old girl. The girl was told she was having an appendectomy. The Supreme Court held the judge was absolutely immune from § 1983 liability, reasoning that "grave procedural errors" do not strip judicial immunity if the act is "judicial in nature" and within the judge's general jurisdiction. The case is widely regarded as the most extreme application of the doctrine.

- **Mireles v. Waco, 502 U.S. 9 (1991).** Per curiam. A judge allegedly **ordered police to forcibly bring a public defender to his courtroom "with excessive force."** The Court applied absolute judicial immunity, holding that the order to use force was "judicial in nature" because it concerned bringing a party before the court — and therefore was immune even though it allegedly directed unlawful violence against an attorney.

**Effect under this Act.** Sections 4.1 and 4.1.1 of this title expressly abrogate judicial immunity for any conduct meeting the elements of any offense defined herein. The cases above — and any state-law analogues — provide **no defense** to civil or criminal liability under Operation Checkmate.
...
**Why the doctrine matters in this bill.** Operation Checkmate abrogates prosecutorial immunity within the scope of this title. See Section 4.1.1. A prosecutor who commits a violation under this Act — including selective non-prosecution under §1.8, knowing use of false evidence as charged under §1.3 (Battery), or obstruction of a Citizen Council under §8.9 — is personally liable, civilly and criminally, without regard to whether the conduct fell within the "advocate" function.

**Supreme Court precedent establishing the doctrine:**

- **Imbler v. Pachtman, 424 U.S. 409 (1976).** The foundational case. The Court held that prosecutors enjoy absolute civil immunity for acts intimately associated with the judicial phase of the criminal process — initiating prosecutions, presenting the state's case at trial — even where the prosecutor allegedly **knowingly used perjured testimony** and suppressed exculpatory evidence to obtain a conviction.

- The line of cases applying *Imbler* — including *Burns v. Reed*, 500 U.S. 478 (1991), *Buckley v. Fitzsimmons*, 509 U.S. 259 (1993), and *Van de Kamp v. Goldstein*, 555 U.S. 335 (2009) — has both extended absolute immunity to additional advocate-role conduct and (in narrow circumstances) limited it where the prosecutor acted as an investigator or administrator. Operation Checkmate **abrogates the doctrine in full** within the scope of this title; the immunity / non-immunity line drawn by these cases has no application to liability under this Act.

**Effect under this Act.** Sections 4.1 and 4.1.1 abrogate prosecutorial immunity for any conduct meeting the elements of any offense defined herein. The cases above — and any state-law analogues — provide **no defense** to civil or criminal liability under Operation Checkmate.
...
**Why the doctrine matters in this bill.** Operation Checkmate abrogates qualified immunity within the scope of this title. See Section 4.1.1. Liability under this Act is determined by the substantive elements of the offense and the actor's mental state under Section 2 — not by whether some prior court has previously ruled the same conduct unlawful.

**Supreme Court precedent establishing the doctrine:**

- **Harlow v. Fitzgerald, 457 U.S. 800 (1982).** The foundational case for the modern doctrine. The Court replaced the older "subjective good faith" standard with an **objective "clearly established law"** test: officials are immune from civil liability *"insofar as their conduct does not violate clearly established statutory or constitutional rights of which a reasonable person would have known."*

- **Anderson v. Creighton, 483 U.S. 635 (1987)**, and the line of cases applying *Harlow* — including *Saucier v. Katz*, 533 U.S. 194 (2001), *Pearson v. Callahan*, 555 U.S. 223 (2009), and many later applications — have refined the test, generally **at a high level of factual specificity** that makes the doctrine difficult to overcome in practice.

**Effect under this Act.** Sections 4.1 and 4.1.1 abrogate qualified immunity for any conduct meeting the elements of any offense defined herein. The "clearly established law" inquiry has **no application** under this title; the substantive elements of the offense and the mens rea framework of Section 2 control.

---

## End of bill content

You have now read the full bill (Operation Checkmate) and the dictionary of legal terms. Wait for the reader's first question, then help them in the way described at the top of this prompt.

Remember:
- Plain language. No legalese.
- Apply it to *their* situation when they share one.
...
- The author is reachable at **citizens.checkmate@gmail.com** with subject `CHECKMATE`.
