# Operation Checkmate — Advanced Overview

> **Looking for the friendly version?** See **[`README.md`](README.md)** for a plain-language summary, real-world examples, and an FAQ aimed at the average citizen. This document is the **section-by-section technical walk-through** for readers who want the full structure, classifications, and cross-references.
...
### Jury Reform (§1.1.4 and §1.1.5)

Two of the most procedurally significant additions:

- **§1.1.4 — Mandatory juror documentation**: no conviction is legitimate unless each convicting juror has personally written a record addressing every item of evidence and explaining the reasoning for finding each element beyond a reasonable doubt. Jurors get as much time as required, no matter how long it takes. Without this record, the accused cannot meaningfully appeal on the facts. A judge who seats a juror unable or unwilling to perform this commits "reckless prosecution" — Class 2 felony, no judicial immunity.
- **§1.1.5 — Juror rights and verdict options**: six available verdicts a jury must be informed of: Guilty, Guilty with Refinement, Guilty and Forgiven (jury nullification with affirmative forgiveness), Innocent, Unequivocally Innocent (affirmative actual-innocence finding that bars retrial), and Acquittal Without Stated Reason. Right to refuse joint deliberation. Right to a separate, private deliberation room. Right against removal for disagreement.
...
- **§1.4 Infraction (Government Context)** — Class 1 infraction (escalating to misdemeanor on repeat). The lower-tier behaviors: smirks, scowls, "you're too close" when the citizen isn't, gestures or posture used to pressure a citizen into surrendering lawful conduct.
...
- **§1.14 Prosecutorial Duty to Disclose Adverse Evidence** — class **mirrors the underlying offense being prosecuted** with a **Class 2 felony floor** (per §1.8 obstruction framework). A prosecutor must disclose to the jury, in open court, all evidence in their possession that would render the prosecution's claim false, establish innocence, mitigate the offense, or impeach a prosecution witness. Disclosure to defense counsel alone is **not sufficient** — the jury must hear it. Continuing duty: applies pre-trial, mid-trial, and post-conviction. Codifies and expands *Brady v. Maryland* (373 U.S. 83 (1963)) by requiring affirmative jury disclosure rather than mere defense disclosure, and by attaching criminal liability to violations rather than only the remedy of vacatur.
- **§1.15 Malicious Prosecution** — **Class 1 felony** (capital where the prosecution results in the citizen's death — capital sentence carried out, death in custody, or suicide consistent with §11.1). A prosecutor who continues to prosecute after knowing or recklessly disregarding clear evidence the citizen is innocent. Includes continued prosecution after exculpatory evidence, witness recantation, third-party confession, or for political/personal/financial/institutional reasons unrelated to truth. Conviction-resulting cases also charge the prosecutor as co-conspirator with any liable jurors under §1.1.3. Prosecutorial immunity (per *Imbler v. Pachtman*) is abrogated; "professional courtesy," "following orders," and "probably guilty of something else" are not defenses.
- **§1.16 Duty to Seek Reduction or Dismissal** — **Class 3 felony** (capital where failure causes the citizen's death). Continuing duty — pre-trial, mid-trial, post-trial, and **post-conviction (years later if necessary)** — to seek reduction or dismissal when the charge does not fit the evidence, the accused is factually innocent, or material evidence has changed. Triggers include new exculpatory evidence, third-party confession, unsupported elements, recognition that the conduct was not criminal, or subsequent legal developments. Duty binds successor prosecutors who inherit cases. Failure is independently chargeable from any other failure; ordinary appellate relief is not a substitute.

**Judicial duties — maintaining the integrity of the court (§§1.17, 1.18, 1.19, 1.20):**

A grouped set of judicial-conduct offenses preceded by a statement of intent: making **judicial impartiality, engagement, and procedural integrity criminally enforceable** rather than merely aspirational. *"The robe is not a license. It is a constraint."* Judicial immunity does not apply (§4.1.1).

- **§1.17 Judicial Duty of Impartiality and Recusal** — **Class 2 felony** (Class 1 with malice; pattern is Cabalism / Racketeering). Affirmative, continuing duty to disqualify from cases involving personal/financial/professional/political/familial interest, prior fixed opinion on the merits, or relationships creating reasonable appearance of bias. Judge must disclose grounds on the record without waiting to be asked. Concealing grounds = Class 2 felony. Convictions/judgments entered after a failure-to-recuse are presumptively subject to vacatur.
- **§1.18 Judicial Duty to Engage on the Merits** — **reckless prosecution** under §1.1.4 (Class 2 felony) or **Anarchy** under §1.10. Prohibits rubber-stamping prosecutorial/law-enforcement requests (warrants, charges, sentencing recommendations) without independent evaluation; requires reasoned written rulings sufficient for appellate or Citizen Council review; bars verbatim adoption of a party's proposed findings without independent review. Pattern conduct may be additionally charged as Cabalism (§1.6) or Government Racketeering (§1.7).
- **§1.19 Prohibition on Ex Parte Communications** — graduated liability: **Class 3** (negligent / single contact), **Class 2** (intentional), **Class 1** (malicious or pattern). Bars substantive ex parte communications about pending matters with parties, prosecutors, witnesses, or third parties. Permitted: routine scheduling, statutorily-permitted communications, and the court's own clerks. Rulings materially influenced by prohibited ex parte communications are presumptively subject to vacatur.
- **§1.20 Judicial Duty to Apply Mandatory Rules and Correct Errors** — graduated liability: **Class 3** (negligent), **Class 2** (intentional), **Class 1** (malicious / pattern). Affirmative, continuing duty to correctly apply the mandatory rules of this title (juror documentation §1.1.4, juror rights §1.1.5, prosecutor disclosure §1.14, mens rea §2, no-immunity §4.1, Council mechanisms §8 including no-gatekeeping §8.4 and Logical Consistency Review §8.14, mandatory prosecution §8.5) — and to correct errors when discovered, by either the judge who erred or any successor. Independently chargeable from any other failure.
...
### Mental State and Defenses (Sections 2–4)

- **§2 — Four-level mens rea framework**. The Act recognizes four graduated mental states: **Negligence** (failure to exercise reasonable care — civil liability only, no criminal prosecution at this level alone), **Recklessness** (conscious disregard of risk; the **default minimum** for criminal liability), **Intent** (purposeful, knowing conduct — elevates classification by one tier), and **Malice** (intent plus ill will — elevates classification by two tiers and bars sentence reduction or plea bargains where the underlying offense is capital). Some offenses require higher minimum mental states by their nature (Treason, Cabalism, Racketeering, and Obstruction require at least intent). Lack of a higher mental state is never a defense to a lower one. Office, policy, and "following orders" are not defenses at any level.
- **§3 — Policy is not a defense**. Internal policies, departmental guidelines, or institutional practices do not excuse violations.
- **§4.1 — No immunity, in any form, for violations under this title**. Qualified immunity, judicial immunity, prosecutorial immunity, sovereign immunity, legislative immunity, and executive immunity — and any state-law analogues — are **expressly abrogated** within the scope of this title. §4.1.1 names and abrogates the specific Supreme Court doctrines: **Bradley v. Fisher** (1872), **Pierson v. Ray** (1967), **Stump v. Sparkman** (1978), and **Mireles v. Waco** (1991) for judicial immunity; **Imbler v. Pachtman** (1976) for prosecutorial immunity; **Harlow v. Fitzgerald** (1982) and progeny for the "clearly established law" test. The asymmetry where a judge can sterilize a child without due process or order force against a public defender and answer to no one — while ordinary citizens face the full weight of the law for far less — ends with this Act.
- **§4.2 — "Following orders" is not a defense**.
- **§4.3 — Public Servant Status**. A government actor cannot invoke personal rights (free speech, expression, opinion) as a defense to official conduct; the badge constrains rather than expands rights.
- **§4.4 — Private-capacity not a shield**. Conversely, an actor cannot escape Council jurisdiction by claiming they were off-duty when the conduct constituted a crime under generally applicable law.

### Penalty Enhancements (§6)
...
- **§8.1 Formed outside the judicial process** — a self-organized assembly of citizens; no court filing, judicial authorization, or government approval needed to convene
...
- **§8.8 Council Order** — written letter signed by 12+ Council members compelling production of records, evidence, and effects without judicial subpoena. **The Sheriff's Office enforces** these orders without delay or warrant; conflict-of-interest fallback to adjacent county / State Police where the sheriff is implicated
...
### Forfeiture of State Benefits, Office, and Contracts (§10)
...
### Death of a Citizen Resulting from Violation (§11)

Where a private citizen takes their own life as a direct or proximate result of conduct violating this title, the violation is a **capital offense**. Other resulting deaths are subject to the maximum penalty otherwise available, with §6 enhancements.

### Severability and Effective Date (§§12, 13)
...
### Constitutional Amendment, Supremacy, and Entrenchment (§14)
...
- **Subject:** `CHECKMATE`
- **Body:** include your **First and Last Name** and **Zip Code**
...
The bill is a **continuously evolving draft** maintained in [`bill_proposal.md`](bill_proposal.md). The full evolution — from the original sketch through every revision — is preserved in the **git history** of this repository (`git log bill_proposal.md` and the commit history of this repo as a whole).
