...
**Working titles:**
- Equal Authority Accountability Act
- Public Power Responsibility Statute
- Government Actor Criminal Liability Act
...
The name of this Act comes from a single idea: **put every wrongful action of government in check, and leave it with no lawful move by which to escape accountability.** The founders of the United States and of the State of Utah established a constitutional architecture of checks and balances. Over time, those checks have eroded — power has consolidated, accountability has been displaced, and the citizen has been pushed from the center of the constitutional order to its margin. This Act is intended to restore the checks and balances the founders set in place, and through them to restore a respectful society in which every person, public servant and private citizen alike, is bound to the same standard of truth and conduct.
...
That is precisely the posture this Act places the third regime of authority in. Officials who have spent generations acting as sovereigns over the citizens they were entrusted to serve — judges shielded by absolute judicial immunity, prosecutors shielded by absolute prosecutorial immunity, officers shielded by qualified immunity, agencies shielded by sovereign immunity — are not removed from the board by this Act. They are simply, finally, bound by the same rules that already bind every other piece on it. The citizen makes the move. The lawful rules of the constitutional order do the rest. **Checkmate.**
...
Government officials have, over time, built around themselves a wall of legal immunities that makes it nearly impossible for ordinary citizens to hold them personally accountable when they abuse public power.

#### The wall

The wall is made of several specific doctrines:

**Sovereign immunity.** The State and its agencies cannot be sued without the State's consent. Most states, including Utah, have only partial waivers (the Utah Governmental Immunity Act, Title 63G Chapter 7), and those waivers are narrow, full of exceptions, and easy for the State to limit further.

**Qualified immunity.** Government officials performing discretionary functions cannot be sued for civil-rights violations unless the right violated was "clearly established" by an earlier court decision involving nearly identical facts. In practice, this means an officer or official can violate a right that any reasonable person would recognize as a violation, and still walk away because no prior case had ruled on the exact factual pattern. *Harlow v. Fitzgerald*, 457 U.S. 800 (1982), and the long line of cases applying it.

**Judicial immunity.** Judges cannot be sued, civilly and in many cases criminally, for acts performed in their judicial capacity — even when those acts are alleged to be malicious, corrupt, in excess of jurisdiction, procedurally defective, or grievously injurious to a citizen. *Bradley v. Fisher*, 80 U.S. 335 (1872); *Stump v. Sparkman*, 435 U.S. 349 (1978); *Mireles v. Waco*, 502 U.S. 9 (1991).

**Prosecutorial immunity.** Prosecutors enjoy absolute civil immunity for acts performed within their advocate role — initiating prosecutions, presenting evidence, examining witnesses, charging decisions, plea negotiations, and grand-jury presentations — even where the prosecutor is alleged to have knowingly used false testimony, fabricated evidence, or suppressed exculpatory evidence. *Imbler v. Pachtman*, 424 U.S. 409 (1976).

**Legislative immunity, executive immunity, governmental-function immunity, discretionary-function immunity, and analogous state-law doctrines** wrap around the rest of the system.
...
A citizen of Utah is bound by hundreds of affirmative duties enforced by criminal law. Failure to perform these duties is itself a crime.

Two terms are important to keep straight before reading what follows, because the most common reply to this section is "of course citizens have to do those things — they have to." That reply gives the game away. *Of course* citizens have to. That is the entire point. Citizens are required, on pain of criminal consequence, to perform their duties. Government officials must be required on the same terms.

**A "duty"** is a legally enforceable obligation to act, or to refrain from acting, in a specific way. A duty is **not optional** — failure to perform it carries legal consequence, often criminal. The examples below are all duties: failure to perform them is a crime.

**"Discretion"** is the lawful choice — granted by law — of how or whether to take certain actions within an authorized space. A citizen has wide discretion in matters of personal liberty: where to live, what to think, what to say, who to associate with, what work to take, what beliefs to hold. **But discretion is bounded by law.** A citizen has discretion to drive a car, but exercising that discretion while drunk is a crime. A citizen has discretion to speak, but exercising that discretion under oath while knowingly lying is perjury — a crime. A citizen has discretion to manage personal finances, but exercising that discretion to hide income from taxation is a crime. A citizen has discretion to keep and bear arms, but exercising that discretion to assault someone is a crime. Across countless examples, the citizen's discretion is **inside the criminal-law fence**: lawful choice within boundaries, with criminal consequence the moment the boundaries are crossed.

Government officials, like citizens, exercise discretion in their offices. A prosecutor has discretion about which cases to charge and how to charge them. A judge has discretion in sentencing within statutory ranges. An officer has discretion about which violations to address and which to let pass. **What the Act criminalizes** is the use of "discretion" as a shield for decisions that do not serve actual justice — only the **perceived justice** the institution produces — and that do not rest on the **actual truth** of what happened, only on the **assumed or constructed truth** the prosecutor or other actor finds convenient. Discretion exercised in service of institutional comfort, conviction rate, career advancement, docket pressure, political preference, agency reputation, or any narrative that displaces objective reality is **not lawful discretion**. It is the unlawful exercise of public power, and this Act treats it as criminal.

The parallel that already exists for citizens is the same: **when discretion is exercised in a way that violates law, criminal consequence attaches.** For citizens, that consequence has always been there — a citizen has discretion to speak, but speaking falsely under oath is a crime; a citizen has discretion to drive, but driving drunk is a crime. For officials, immunity doctrines have removed that consequence. This Act puts it back.

**The lawful discretion of a government actor has three hard limits.** No discretion authorizes the violation of a citizen's protected rights. No discretion authorizes breaking the law in order to enforce the law. No discretion authorizes interpreting the law in favor of the government actor, the office, the agency, or the State's institutional interest — the lawful purpose of every interpretive choice an official makes is **the actual truth and the protection of the citizen whose rights are at issue**, not the convenience of the office, the reputation of the agency, the career of the prosecutor, the docket of the judge, or the comfort of the State. Where an official's discretion crosses any of those three lines, it is not lawful discretion at all. It is the unlawful exercise of public power, and this Act treats it as such.

Citizens do not get to invoke "I had discretion" as a shield against perjury, hit-and-run, tax fraud, or any of the dozens of crimes that punish the unlawful exercise of personal liberty. Officials should not get to invoke "I had discretion" as a shield against malicious prosecution, knowing use of false evidence, refusal to recuse from a case where they have a financial interest, or any of the dozens of crimes that punish the unlawful exercise of public power.

With that framing in place, the citizen duties enforced by criminal law are everywhere in daily life:

- **Pulling over when an officer signals.** Failure to stop is "fleeing" or "evading," a misdemeanor and in many circumstances a felony. Utah Code §41-6a-210.
- **Producing a driver license, registration, and proof of insurance when stopped.** Refusal is a separate offense. Utah Code §41-6a-209.
- **Stopping at the scene of an accident.** Leaving = "hit and run," a misdemeanor or felony depending on injury. Utah Code §41-6a-401, 402.
- **Reporting an accident involving injury, death, or property damage** to law enforcement. Failure = misdemeanor or felony.
- **Filing tax returns and paying taxes.** Failure = tax evasion, a state and federal crime.
- **Registering with the Selective Service** (males 18–25). Failure = federal felony, 50 U.S.C. § 3811.
- **Reporting suspected child abuse, if a mandatory reporter** (teachers, medical professionals, social workers, clergy in some jurisdictions). Failure = misdemeanor or felony.
- **Showing up when subpoenaed as a witness.** Failure = contempt of court.
- **Showing up for jury duty.** Failure = contempt.
- **Being truthful on government forms.** False statement = perjury or false-statement felony — federally, 18 U.S.C. § 1001.
- **Sex-offender registration.** Failure to register or update = felony.
- **Maintaining motor-vehicle financial responsibility.** Operating without it = class C misdemeanor. Utah Code §41-12a-302.
- **Sending children to school.** Truancy can produce contempt, fines, and in some jurisdictions jail for the parent.
- **Yielding to emergency vehicles.** Failure = misdemeanor.
- **Stopping at red lights and stop signs.** Failure = infraction or misdemeanor.
- **Paying court-ordered child support.** Failure = contempt and, where willful, criminal nonsupport.
- **Surrendering firearms under a qualifying protective order.** Failure = federal felony, 18 U.S.C. § 922(g)(8).
- **Notifying the DMV of address change within the statutory period.** Failure = misdemeanor.
- **Identifying yourself when an officer has reasonable suspicion**, in stop-and-identify jurisdictions. Failure = misdemeanor.
- **Lying to a federal officer.** False statement = federal felony, 18 U.S.C. § 1001 (the Martha Stewart conviction).
- **Lying under oath in any proceeding.** Perjury = felony.
- **Tampering with or destroying evidence**, even one's own. Felony.
- **Failing to appear in court** after release on bond. Misdemeanor or felony, plus bond forfeiture.
- **Failing to obey a lawful court order.** Civil and criminal contempt.

That is a partial list. The point is the **pattern**: where the State decides that public order or safety requires a citizen to act, the State enforces that requirement with the criminal law. The State does not say "we hope citizens will pull over." It says "if you do not pull over, you have committed a crime." It does not say "we hope citizens will file taxes." It says "if you do not file taxes, you have committed a crime." It does not say "we hope citizens will register if they have been convicted of a sex offense." It says "if you fail to register, you have committed a felony."

The State has built an entire architecture of citizen affirmative duties enforced by criminal law because, the State explains, **public order requires it**.

Now turn the question around.

A government official holds delegated public power. That power can take a citizen's liberty, property, family, livelihood, reputation, and life. The misuse of that power is at least as dangerous to public order as a citizen's failure to file a tax return — and is often dramatically more dangerous. Yet the State that bound the citizen with criminal-law duties has, for itself, declined to do the same.

- A citizen who lies on a tax form commits a felony. A prosecutor who lies to a jury hides behind absolute prosecutorial immunity.
- A citizen who fails to stop for an officer commits a crime. An officer who continues to question a person who has invoked counsel faces, under current law, no criminal consequence at all.
- A citizen who fails to register as a sex offender commits a felony. A judge who fails to disclose a financial interest in a case faces, at most, judicial-conduct review behind closed doors.
- A citizen who lies to a federal officer commits a felony. A federal official who lies to Congress about whether the agency collects data on millions of Americans gives "the least untruthful" answer and keeps the job.
- A citizen who fails to pay court-ordered child support faces contempt and criminal nonsupport. A government that funds a public-defense system at a level that makes effective representation impossible faces nothing.
- A citizen who tampers with evidence is a felon. A police department that fails to preserve body-camera footage that would have impeached an officer's testimony faces, at most, a discovery sanction the prosecutor will negotiate around.
- A citizen who fails to appear in court is jailed. A prosecutor who fails to disclose exculpatory evidence under *Brady* almost never faces personal consequence — the remedy, if there is one, is reversal of the conviction, not punishment of the prosecutor.
- A citizen who refuses to identify themselves to a peace officer in a lawful stop is jailed. A peace officer who refuses to identify themselves to a citizen who asks during a lawful encounter faces no criminal liability under most existing law.

The asymmetry is the point of this Act. **If citizens are required, on pain of criminal prosecution, to perform affirmative duties — to register, to file, to stop, to disclose, to report, to identify themselves, to pay, to appear, to surrender, to be truthful — then government officials, who hold delegated public power and whose failure can take a citizen's liberty or life, must be required to perform parallel affirmative duties on the same terms.**

There is no principled basis for the asymmetry. The traditional answer — that immunity is necessary so officials can do their jobs without fear — does not survive scrutiny. Citizens do their jobs every day under the threat of criminal prosecution for tax fraud, perjury, fleeing, hit-and-run, failure to register, failure to pay, failure to appear. Citizens manage to do their jobs anyway. So can officials. The duties this Act imposes are not novel intrusions; they are the parallel of duties the State has already long imposed on the citizens it governs.

Operation Checkmate ends the asymmetry. It defines official affirmative duties parallel to the duties already imposed on citizens, and it makes failure to perform those duties criminal — exactly as the State has long made failure to perform citizen duties criminal. **What is good enough for the citizen is good enough for the official.**

#### Why civil reform alone doesn't work

For decades, reformers have tried to chip away at the wall by **removing immunities in civil cases**. Some states have ended qualified immunity in their civil-rights statutes. Some legislatures have expanded sovereign-immunity waivers. Some plaintiffs have won landmark cases.

It hasn't been enough. Two structural reasons:

**1. The official is still not personally on the hook.** Even where civil immunity is removed, the State or municipality pays the judgment. The official keeps the job, keeps the pension, keeps the title. The taxpayer pays. The official walks away.

**2. The right to sue requires money, time, lawyers, and survival.** A citizen who has been harmed by government — wrongfully arrested, wrongfully prosecuted, wrongfully convicted, wrongfully separated from their children, wrongfully foreclosed, wrongfully deported — usually does not have the resources to file and prosecute a civil case against the State and its lawyers. The wall stays standing because the people on the wrong side of it cannot afford the rope to climb over.

#### The criminal-law key

Criminal prosecution operates differently from civil suit. In a criminal case:

- **The prosecutor — not the harmed citizen — bears the cost** of bringing the case.
- **The official is personally on the hook.** A criminal conviction goes on a person, not on a public budget. The State cannot indemnify a person out of a criminal record.
- **The remedies are personal:** loss of office, loss of pension, prison, fines, permanent disqualification from holding public power again.
- **Most of the immunity doctrines do not apply, or apply far more weakly, to criminal prosecution.** Judicial immunity is a civil-liability doctrine. Prosecutorial immunity (under *Imbler*) is a civil-liability doctrine. Qualified immunity is a civil-liability doctrine. Sovereign immunity is a civil-liability doctrine. These doctrines were built to protect officials from being **sued** — not from being **charged**.

What this means is simple and powerful: **if a citizen can convert official misconduct into a crime, the wall comes down for that conduct.**

#### Why making it a crime is the answer — not a step, the answer

Operation Checkmate uses this insight as its central engine.

**It defines official misconduct as crime.** Assault under color of authority, battery, obstruction, malicious prosecution, recklessly maintaining a known-false case, falsifying records, wrongful conviction, retaliation against whistleblowers and complainants, refusal to recuse, ex parte communications about pending cases, ineffective assistance of counsel, custodial coercion, badge coercion, eminent-domain manipulation, regulatory weaponization — these are not civil torts in this Act. They are crimes.

**It creates affirmative duties and makes the failure to perform them a crime.** A prosecutor's duty to disclose adverse evidence to the jury — failure is criminal. A prosecutor's duty to investigate actual innocence — failure is criminal. A prosecutor's duty to seek dismissal when the evidence collapses — failure is criminal. A judge's duty to recuse where there is a conflict — failure is criminal. A judge's duty to engage with the merits — failure is criminal. An officer's duty to honor an invocation of rights, to record the encounter, to identify themselves — failure is criminal. A public defender's duty to refuse a caseload that prevents effective representation — failure is criminal. The State's duty to fund a public-defense system at a level that permits effective representation — failure is criminal.

This converts **inaction** into reachable conduct. Most immunity doctrines protect official **action**; they have weaker hold on the active concealment of a duty owed to a citizen. By turning the duty itself into a criminal predicate, the bill brings the failure inside the criminal law's reach.

**It explicitly abrogates immunity within the scope of the Act.** Section 5.1.1 names the doctrines — judicial immunity (Bradley, Pierson, Stump, Mireles), prosecutorial immunity (Imbler), qualified immunity (Harlow and progeny), sovereign immunity, legislative immunity, executive immunity, governmental-function immunity, discretionary-function immunity — and abrogates each of them within the State of Utah for any offense defined in this Act. Whatever residual application those doctrines might still have to criminal prosecution, this Act removes any application within its scope.

#### The piece that makes it real: citizen-forced prosecution

A criminal law is only as strong as the willingness of the prosecutor to use it. If the official whose conduct is being prosecuted is in the same office, party, agency, fraternal lodge, or political circle as the prosecutor, a normal criminal-law fix would die in the prosecutor's office. The wall would just shift one room over.

Operation Checkmate closes that gap with the **Citizen Council** mechanism (Section 9). Twelve or more citizens — meeting outside the judicial process, without judicial supervision, without the cooperation of any government office — can issue a **Joint Declaration of Prosecution**. That Declaration has the legal force of a grand-jury indictment when filed in court. The County Prosecutor's Office **must** prosecute it. If the County Prosecutor declines, has a conflict, or fails to act within thirty days, the Office of the Governor must designate counsel to prosecute the matter without further delay.

The Citizen Council can also issue Council Declarations to compel production of records, to seek warrants, and to seek arrests — with the Sheriff's Office obligated to enforce. Inmates can form Citizen Councils from inside facilities. **Logical Consistency Review** (twelve unanimous citizens) can nullify a statute that conflicts with controlling law. **Conviction Review** (eighteen unanimous citizens) can nullify, reduce, or extend public forgiveness to a criminal conviction.

The citizens are the activator. The citizens force the prosecution. The citizens decide what the official prosecutor is too captured, too political, too tired, or too friendly to charge.

#### Why this — and not another civil suit, another reform, another commission

Civil suits depend on lawyers and money the harmed citizen does not have.

Internal-affairs investigations are run by the same institutions whose officers are being investigated.

Civilian review boards have no power to charge anything.

Federal monitorships have repeatedly failed to address misconduct.

The Inspector General's office reports to the executive whose conduct is often in question.

The professional-discipline boards police their own.

The Judicial Conduct Commission decides which judges to discipline behind closed doors.

Operation Checkmate routes around every one of these dead ends. It puts a substantive criminal predicate on the conduct, makes the failure to perform a duty also criminal, abrogates the immunity doctrines that would shield the conduct from civil reach, and gives the citizens themselves — not the captured offices — the power to force the prosecution.

#### Where the wall stands

**Where the wall stands today:** a citizen harmed by official misconduct must usually find a lawyer, file a civil case in federal or state court, survive qualified-immunity dismissal motions, hope for a sympathetic judge, hope a jury awards meaningful damages, hope the State does not appeal, hope the official (who keeps the job through all of it) eventually faces some consequence, and most often watches the entire thing settle for a sum the State pays from the same taxes the citizen paid in.

**Where the wall stands after this Act:** the misconduct is itself a crime. The duty is itself a crime to fail to perform. The immunity is abrogated within the State of Utah for any offense in the Act. The citizens — twelve of them, organizing themselves outside any court or government office — file a Joint Declaration. The County Prosecutor must prosecute. The Sheriff must enforce. The official faces personal criminal liability, loss of office, loss of pension, and permanent disqualification from holding public power again.

That is the answer.

It is not a partial answer. It is not a proposal for civil reform. It is not a request for the legislature to be more careful. It is the structural mechanism that closes the gap between the citizen's right and the official's accountability for violating it. Every element of the bill — the offenses, the affirmative duties, the failure-to-perform liability, the immunity abrogation, the Citizen Council, the Joint Declaration, the mandatory-prosecution rule, the Sheriff-enforced Council Declarations, the Logical Consistency Review, the Conviction Review — is a piece of one machine. They work because they work together.

There are no kings in America. This is what it takes to make that true in practice.
...
- Federal officers and agents **acting under color of federal law**, including but not limited to FBI, DEA, ATF, U.S. Marshals, ICE, CBP, Secret Service, IRS criminal investigators, and analogous federal agencies
- Federal prosecutors (U.S. Attorneys, Assistant U.S. Attorneys, DOJ trial attorneys)
- Federal judges, magistrate judges, and administrative law judges

**Law Enforcement (State, County, Local):**

- **Any peace officer**, however titled, exercising arrest, detention, search, or enforcement authority
- State, county, and municipal law enforcement officers
- Sheriffs, deputies, and constables
- Corrections officers, jail staff, and detention officers
- Parole, probation, and pretrial-services officers
- Court bailiffs and process servers
- Tribal, transit, port, and university police acting under color of law
...
- Governors, attorneys general, and their deputies
- **Mayors** and city/town managers
- **City council members**, county commissioners, town selectboards, and other elected local legislative officials
- Appointed city, town, and county officials, department heads, and division chiefs
- **Any city or municipal official** acting under color of office

**Regulatory and Administrative:**

- Regulators and administrative officers exercising enforcement, licensing, or inspection authority
- Code enforcement officers, building inspectors, fire marshals, licensing officers
- Child protective services and adult protective services workers exercising removal or custody authority
- Tax assessors and revenue agents acting in an enforcement capacity

**Education:**

- School superintendents, principals, and assistant principals
- School resource officers and school district police
- School board members
- Truancy officers and disciplinary officers
- **Any school official** acting in an enforcement, disciplinary, custodial, or coercive capacity over a student or parent
...
**Entities included as government actors under this section:**

> **Any department or agency at any level of government** — federal, state, county, municipal, special district, or otherwise — is a government actor under this title, in addition to the broader categories of governmental bodies set out below.

The following are included, without limitation:

**Governments at every level:**

- **Federal government** and the United States as an entity
- **State governments** — including the State of Utah, its officers, and its constituent components
- **County governments**
- **Municipal governments** — cities, towns, villages, boroughs, and any subdivision of a municipality

**All Departments, Agencies, and Bureaus — at Every Level:**

- **Federal departments, agencies, bureaus, administrations, and offices** — including but not limited to executive departments (e.g., Justice, Treasury, HHS, DHS, etc.), independent agencies, and quasi-governmental corporations
- **State departments, agencies, divisions, commissions, and offices** — including but not limited to executive departments, regulatory agencies, licensing boards, professional boards, and inter-agency bodies
- **County departments, agencies, offices, and commissions** — including but not limited to county recorder, assessor, attorney, public works, planning, zoning, and human-services departments
- **Municipal departments, agencies, offices, and commissions** — including but not limited to police, fire, public works, planning, zoning, code enforcement, parks, utilities, and licensing departments
- **Independent agencies and commissions** at any level — those operating outside the direct chain of command of an executive — are included as standalone government actors
- **Quasi-governmental agencies, public corporations, public authorities, and government-sponsored enterprises** that exercise governmental power, perform governmental functions, or disburse public funds

**Specialized Bodies:**

- **School districts, school boards, and any educational governing body** including charter authorizers and intermediate education districts
- **Special districts** (water, fire, transit, port, sanitation, library, cemetery, irrigation, hospital, mosquito-control, etc.)
- **Police departments, sheriff's offices, and other law-enforcement agencies** as institutional bodies
- **Corrections departments, jails, and detention authorities** as institutional bodies
- **Court systems** and judicial administrative bodies
- **Regulatory commissions, licensing authorities, and professional boards**
- **Tribal-state and inter-jurisdictional agencies** acting under color of any law affecting Utah citizens

**Catch-all:**

- Any other body, department, agency, division, office, commission, board, authority, council, or organization that **exercises state power**, **issues binding decisions affecting citizens**, **performs a traditionally governmental function**, or **disburses funds derived from public sources**

> The form, name, organizational chart, or budget line of an entity does **not** determine whether it is a government actor. The substance — whether it exercises state power or performs governmental functions — is what determines coverage under this section.

**Triggering Conduct:**

A government body is liable as a government actor under this title where:

- It adopts a **formal action** (vote, resolution, ordinance, policy, directive, regulation, or rule) that authorizes, commands, or ratifies conduct violating this title; **or**
- It engages in a **pattern or practice** of conduct violating this title; **or**
- It **fails to act** to prevent or correct violations by its personnel where it knew or should have known of the violations
...
**Remedies Available Against an Entity:**

- **Monetary damages, fines, and forfeitures** payable from the entity's general fund or other available resources, without indemnification of any individual actor
- **Forfeiture of state-derived funding**, grants, or revenue streams consistent with Section 11
- **Disqualification from receiving government contracts, grants, or subsidies** for a period commensurate with the offense
- **Court-ordered structural reforms**, independent monitorships, training mandates, or operational restrictions
- In the most serious or repeated cases: **dissolution, restructuring, or receivership** of the body or specific subdivisions

**No Indemnification of Individuals from Entity Funds:**
...
This includes, without limitation, jurors seated on **grand juries**, **petit juries**, **trial juries**, **state juries**, **federal juries**, county juries, municipal juries, and any other jury body exercising public authority over a citizen.
...
> Places a citizen in a position where a reasonable person would believe they may be required to defend their rights, liberty, or property — **including the need to defend those rights in a court of law**.

This includes, but is not limited to:

- Threats of unlawful detention
- Coercive commands lacking lawful basis
...
> Engages in any utterance, gesture, expression, or other minor coercive conduct that, while falling short of assault or battery, would reasonably direct, pressure, or suggest to a citizen that the citizen should act contrary to their rights, liberty, or property.

This includes, but is not limited to:

- Statements such as *"you're too close,"* *"step back,"* *"move along,"* or similar utterances issued in circumstances where the citizen is **not, in fact, too close** and no lawful basis exists for the directive
- Smirks, scowls, eye-rolls, or other facial or expressive conduct that would reasonably signal to a citizen that they are doing something wrong when they are acting within their rights
- Tone, posture, gestures, or staging of authority calculated or reasonably likely to suggest unlawfulness on the part of a citizen who is engaged in lawful conduct
- Indirect, implied, or non-verbal commands lacking lawful basis that pressure a citizen to surrender, modify, or curtail the exercise of a right
...
- All rights recognized in the **Universal Declaration of Human Rights (UDHR)**
- All rights set forth in the **International Covenant on Civil and Political Rights (ICCPR)**
- All rights set forth in the **International Covenant on Economic, Social and Cultural Rights (ICESCR)**
- All rights recognized in any other United Nations human-rights treaty, convention, declaration, or covenant, or which reflect generally accepted norms of international human rights

**United States Constitutional Rights:**

- All rights, privileges, and immunities enumerated in the **United States Constitution** and its amendments
- All rights, privileges, and immunities **retained by the people but not enumerated**, as preserved by the **Ninth Amendment**
- All rights recognized by binding decisions of the United States Supreme Court or applicable federal courts

**State Constitutional Rights:**

- All rights, privileges, and immunities recognized in the **constitution of any state**, including provisions that meet or exceed federal protections

**Written and Unwritten Rights:**

- Rights expressed in any written law, charter, statute, treaty, or instrument
...
- The right to **speak one's mind** — free speech, expression, and dissent
- The right to **freely exercise one's religion**, to worship one's god (by any name or none), or to hold no religion at all
- The right to **keep and bear arms**, including the lawful ownership, possession, and carry of firearms
- The right to **be a parent** — to raise, educate, discipline, and direct the upbringing of one's children, free from unwarranted state interference
- The right to **freedom of movement and travel**
- The right to be **secure in one's person, home, papers, and effects** against unreasonable searches and seizures
- The right to **due process of law**
- The right to **peaceably assemble**, associate, and petition for redress of grievances
- The right to **bodily autonomy and medical self-determination**
- The right to **privacy** in personal, familial, and household matters
- The right to **earn a living** and engage in any lawful occupation
...
For purposes of this Act, the practical means of exercising a protected right are **part of the right itself**. They are not separate privileges, conveniences, licenses, favors, or discretionary benefits that the government may withhold while claiming the right still exists.

A government actor may not acknowledge a right in name while denying, pricing out, criminalizing, licensing away, delaying, obstructing, or making impossible the ordinary means by which the citizen can actually use the right. A right that cannot be exercised in real life is not a right within the meaning of this Act; it is a privilege granted or withheld by government discretion.

This principle applies wherever the right would be hollow without ordinary access to the means of exercise. Examples include, without limitation:

- **Interstate travel and ordinary roads:** the right to interstate travel includes the practical ability to move from place to place by ordinary public routes. A citizen cannot meaningfully possess the right to travel from one state to another if the government may deny, price out, criminalize, or convert into a privilege the ordinary use of public roads and routes needed to get there. A right to travel without the practical means to travel is not a right; it is permission for those whom the government chooses to allow or those who can afford the imposed barrier.
- **Speech and public communication:** the right to speak includes the practical ability to communicate in ordinary public forums, to publish, to record, to distribute, to attend public meetings, and to speak to government without retaliation.
- **Petition and public records:** the right to petition includes access to filing, records, clerks, public offices, agendas, hearings, and other ordinary channels needed to make the petition real.
- **Defense in court:** the right to defend oneself includes access to evidence, witnesses, counsel, court process, filings, transcripts, records, and meaningful time to prepare.
- **Earning a living:** the right to earn a living includes ordinary access to tools, transportation, licenses, permits, property, markets, communications, and other practical means necessary for lawful work.
- **Keeping and bearing arms:** the right to keep and bear arms is not limited to firearms alone. For purposes of this Act, an arm includes any lawful arm, weapon, tool, or implement that a citizen may keep, carry, or use for lawful defense of self, family, home, property, or another person. The right to bear an arm includes the practical ability to possess, carry, transport, maintain, train with, and lawfully use the borne arm in self-defense. The exercise of that right does not become a public nuisance merely because another person dislikes, fears, is annoyed by, is inconvenienced by, or politically objects to the citizen's lawful exercise of the right.

The government may regulate the manner of exercising a right only within lawful constitutional authority, with logical consistency, and without converting the right into a wealth-conditioned, permission-only, or retaliation-vulnerable privilege.

The lawful limit of a right is actual unlawful harm, direct rights-violating conduct, or an imminent unlawful threat supported by specific facts about the citizen's own conduct. "Specific facts" under this subsection means facts showing that the particular citizen, in the particular situation, has crossed or is imminently crossing a lawful boundary. It does not mean population statistics, generalized risk studies, predictive profiling, fear of what other people have done, or speculation that a lawful act might become unlawful because similar acts have sometimes preceded harm. For example, a citizen being outside while lawfully carrying an arm is not unlawful merely because some people who carry guns later commit shootings. Regulation becomes available when the citizen's own conduct becomes assault, battery, unlawful threat, unlawful discharge, brandishing with unlawful intent, or other actual rights-violating conduct.
...
**Unjust effect** under this section includes, but is not limited to:

- Inducing **fear** in citizens
...
- **Taking, seizure, forfeiture, encumbrance, or destruction of property** in a manner that makes it **difficult or impossible for a citizen to run a lawful business, earn a living, or sustain a household**, including but not limited to:
  ...
  - Disproportionate fines, fees, or surcharges
  - Revocation, denial, or non-renewal of licenses, permits, or certifications used in trade or profession
...
- **Intimidate citizens**
- Compel citizens to **pay money, fees, fines, surcharges, or other consideration** without lawful basis
- **Extort, coerce, or extract** payment, property, or benefit through threat or implication of governmental action
- **Selectively enforce** laws, regulations, or ordinances against specific persons or groups for purposes unrelated to the public interest
- Operate any **scheme or pattern** of such conduct, whether continuous or episodic

**Includes, without limitation:**

- Schemes to extract civil fines, asset forfeitures, ticketing quotas, towing or impoundment fees, or similar revenue from citizens without lawful basis
- Coordinated use of regulatory, licensing, inspection, enforcement, or judicial power to punish, pressure, or coerce
- Use of public office for personal, family, or institutional financial gain at citizen expense
- "Pay-to-play" arrangements involving government services, permits, contracts, or licenses
- Coordinated harassment via repeated stops, citations, inspections, or process targeting an individual, business, or community
...
>
> **(a)** Fails or refuses to **prosecute** the person for a crime, where sufficient evidence to support charges exists; or
>
> **(b)** Fails or refuses to **arrest** the person, where lawful grounds for arrest exist; or
>
> **(c)** Fails or refuses to **charge** the person, where the elements of an offense are met,
>
> **and** the official's inaction is **caused by, motivated by, or substantially influenced by** the person's title, status, group affiliation, organizational membership, or other connection.

**Disqualifying motivation includes, but is not limited to, the person's:**

- Status as a current or former government actor, officer, or employee
- Membership, leadership, or affiliation in a **church, religious organization, or fraternal order**
- Membership, office, or affiliation in a corporation, partnership, business association, or industry group
- Relation to, friendship with, or political/financial connection to any government official
- Belonging to any club, society, lodge, or other network with which the official has a personal, financial, or political connection

**Elements:**

- The actor is a government official with **prosecutorial, arrest, or charging authority** (including but not limited to prosecutors, peace officers, sheriffs, federal agents, and supervisors with charging discretion)
- A private person committed, or is reasonably alleged on the available evidence to have committed, a crime
- The official failed or refused to prosecute, arrest, or charge that person
- The failure was caused by, motivated by, or substantially influenced by the person's title, status, group membership, or organizational affiliation

**Classification (mirrors the underlying offense, with a Class 2 floor):**
...
**Application via Section 9:**

A Citizen Council acting under Section 9 may investigate and issue a Joint Declaration of Prosecution for obstruction under this section. The Council's jurisdiction extends to obstruction whether the underlying crime is one defined within this title or one defined under generally applicable criminal law (see Section 9.10).

**Affirmative defenses limited:**

- A claim of **prosecutorial discretion** is **not** a defense where the failure to act was motivated by the person's title, status, or affiliation
...
For purposes of this section, **"the state" is not a corporate or institutional abstraction**. The state is:

- **The actual citizens** of the State of Utah and of the United States
- The **Constitution of the United States** as the supreme law of the land
- The **Constitution of the State of Utah** as the supreme law of the State

A government actor who attacks, undermines, betrays, or wages war against any of the foregoing has made war against **the state itself**. An attack on a corporate or institutional entity that does not also harm the citizens, the U.S. Constitution, or the Utah Constitution is **not** treason under this section.

**War — Defined Broadly:**

> War, for purposes of this section, is **not limited to armed conflict**. War has historically been waged, and continues to be waged, through **financial burden, taxation, regulation, and economic coercion** as much as through force of arms. Treason recognizes the substance of war, not merely its outward form.

War against the state under this section includes, but is not limited to:

- **Financial warfare** — the imposition of **taxes, fees, fines, surcharges, levies, or other financial burdens** on citizens that are calibrated, designed, or operated to impoverish, displace, dispossess, or break the citizens' capacity to exercise their rights, sustain their families, or live freely
- **Constitutional warfare** — the deliberate, sustained subversion or violation of the **U.S. Constitution** or the **Utah Constitution** by an actor sworn to uphold either
- **Regulatory warfare** — the use of regulation, licensing, permitting, or inspection power in a coordinated and sustained way to deprive citizens of livelihood, property, or liberty
- **Procedural warfare** — the deliberate manipulation of legal process, prosecutorial discretion, or judicial proceedings to break specific persons or classes of citizens
- **Information warfare** — the deliberate fabrication, distortion, or suppression of information about citizens by state actors to enable any of the foregoing
- **Armed insurrection, sabotage, or military action** by a government actor against citizens of the state
...
- Detention, arrest, or use of force without any statutory authority and without exigent circumstances
- Issuance of orders, commands, or directives that have no foundation in any law of any jurisdiction
- Imposition of fines, fees, sanctions, or penalties for which no enabling authority exists
- Confiscation, seizure, or destruction of property without warrant, court order, or statutory ground
- Restriction of speech, assembly, religion, movement, or other rights without any legal predicate
- Enforcement of "rules" that exist nowhere in published law

**Policy Is Not a Defense:**

> The fact that an internal policy, departmental rule, agency regulation, or institutional practice **purported to authorize** the conduct **shall not be a defense** under this section. **Policy that authorizes lawless conduct is itself lawless.**

A policy is "lawless" within the meaning of this subsection where:

- The policy itself lacks lawful basis in statute, ordinance, or constitutional authority
...
The average citizen of Utah is **not represented** by a paid lobbyist. The paid-lobbyist function, when funded from outside the State, operates to insert the priorities of out-of-state entities, foreign nations, and foreign capital into legislation, regulation, and policy that governs the lives of actual Utah citizens. This insertion **displaces the voice of the citizen** and constitutes a form of small-group control of political affairs producing unjust effect — that is, **cabalism**.

**Definitions:**

For purposes of this section:

- **"Lobbyist"** means any person who, for compensation, communicates with a government actor for the purpose of influencing legislative, regulatory, executive, or judicial action affecting the State of Utah, its political subdivisions, or its citizens
- **"Foreign"** means **outside the State of Utah** — including any other state of the United States, any U.S. territory, any foreign nation, and any entity or person not domiciled or resident within Utah
- **"Foreign-Funded"** means receiving compensation, salary, retainer, expense reimbursement, or any other thing of value, **directly or indirectly**, from any source not domiciled or resident within the State of Utah

**Prohibited Conduct (Lobbyist):**

It is unlawful under this title for any lobbyist to:

- Engage in lobbying activity affecting the State of Utah while **not a Utah resident**
- Engage in lobbying activity affecting the State of Utah while **paid in whole or in part by foreign sources** (other states, other countries, or any non-Utah entity or person)
- **Conceal, misrepresent, or fail to disclose** foreign sources of compensation in connection with any lobbying activity affecting Utah
- Use intermediaries, pass-through entities, or shell organizations to obscure the foreign source of compensation

**Prohibited Conduct (Government Actor):**

It is unlawful under this title for any government actor to:

- **Knowingly receive lobbying communication** from a person known or who reasonably should be known to be foreign-funded
- Vote on, advance, sponsor, or otherwise take action on any matter materially shaped by foreign-funded lobbying without **disclosing the foreign funding** on the public record
- **Solicit, accept, or be influenced by** foreign-funded lobbying in the exercise of public office

**Required Disclosures:**

Every lobbyist active in Utah shall disclose, before commencing lobbying activity and on a continuing basis:

- The lobbyist's place of residence
- Every source of compensation, in any form, received in connection with lobbying activity
- The **state or country of domicile** of every funding source, traced through any intermediary
- The amount of compensation from each source

Disclosures shall be **public records**, accessible without fee or undue procedural burden, consistent with Section 9.7.
...
The following are **not** prohibited under this section:

- A **Utah citizen communicating with their own elected officials** about matters of public concern, whether or not paid — constituent contact, including organized advocacy by Utah residents, is **not** lobbying for purposes of this section
- A **Utah-based business, association, or non-profit**, with substantial operations and a controlling presence in Utah, lobbying for its members or interests through Utah-resident lobbyists, with funding from Utah-sourced revenue
- **News reporting, opinion writing, academic publication, or other speech** not directed personally at a government actor for the purpose of compensated influence
- **Sworn testimony** before a legislative body, court, or other official proceeding

**Defenses Limited:**

- A claim that the foreign-funded lobbying activity was "compliant with the existing Lobbying Disclosure Act" or other prior law is **not a defense** where the activity satisfies the elements of this section
- The fact that the foreign-funded activity was conducted **openly** is not a defense — openness about foreign capture is still foreign capture
...
>
> - The citizen's **financial wellbeing**
> - The citizen's **family or family wellbeing**
> - The citizen's **business, livelihood, or economic wellbeing**
> - The citizen's **physical safety**
> - The citizen's **liberty**
> - The citizen's **standing or reputation in the community**
> - Any other fundamental aspect of the citizen's life

**Forms of Terror Include, But Are Not Limited To:**
...
- Use of any combination of the foregoing as a pattern of conduct

**Elements:**

- The actor is a government actor
- The actor's conduct constitutes terror, threat, intimidation, or coercion
- The conduct is directed at a citizen
- The conduct targets the citizen's wellbeing in any of the categories above
- The actor knew, or in reckless disregard of clear evidence should have known, that the conduct was unlawful or grossly disproportionate to any lawful purpose
...
- Repeated visits, calls, or contacts that pressure a citizen without lawful purpose
- **Vague or veiled hints** of negative consequences for non-cooperation
- Drawn-out investigations, delays, or proceedings used to **wear down a citizen's resistance**
- Bureaucratic obstruction or runaround designed to discourage the exercise of rights
- Publication or threatened publication of citizen information for the purpose of pressure or punishment
...
- The actor is a government actor
- The actor's conduct, while acting under color of authority, induces **undue anxiety, fear, or distress**
- A **reasonable person** in the citizen's position would experience the anxiety as **unjustified by any lawful purpose**
- The actor **knew, or should have known**, that the conduct would have that effect
...
The Act recognizes a graduated set of offenses for government-actor conduct that affects a citizen's emotional and psychological wellbeing:
...
- The actor is a government actor
- The actor initiates, continues, directs, approves, facilitates, or materially supports the prosecution of a citizen
...
- The actor nonetheless causes, continues, assists, or permits the prosecution to proceed

**Includes, but is not limited to:**

- Continued prosecution after exculpatory evidence has come to the actor's attention
...
- Refusal to seek, recommend, approve, or permit dismissal where the available evidence no longer supports the elements of the charged offense
- Knowingly supplying, approving, relying on, or failing to correct reports, affidavits, testimony, forensic material, charging recommendations, or investigative claims that keep the prosecution alive despite clear evidence of innocence
...
- The doctrine of **prosecutorial immunity, qualified immunity, judicial immunity, sovereign immunity, or any analogous immunity does not apply**, consistent with Section 5.1.1
...
An affirmative duty need not be expressly listed in this Act if the duty is reasonably derived from the nature of the office, role, authority, oath, legal obligation, constitutional obligation, or government function being exercised. An affirmative duty is not discretionary. Where an affirmative duty applies, the government actor must perform that duty without waiting for a citizen request, defense motion, court order, supervisor approval, appellate reversal, media attention, or post-conviction discovery, unless a specific section or controlling law expressly provides otherwise.

**Criminal Enforceability:**

- Failure to perform an affirmative duty is enforceable by criminal prosecution where the failure meets the mental-state requirements of Section 3
- The omission, refusal, delay, concealment, or partial performance of an affirmative duty is treated as conduct under color of authority
...
#### 1.1.18 Terms Describing Unlawful Official Conduct

The following terms appear throughout this Act in connection with the limits of lawful official authority — most prominently in §5.1 (Fixing the Immunity Gap), where immunity is denied for any official conduct that meets any of these descriptions. They are defined here for clarity and uniform application across the Act. Where a term in this subsection is also defined or operationalized in another section (notably **malicious** in §3 and §1.1.16), the more specific provision controls within its own scope, and this subsection supplements rather than displaces it.

**Unconstitutional.** Conduct, statute, ordinance, regulation, policy, practice, order, or other government instrument that violates the Constitution of the United States, the Constitution of the State of Utah, this Act, or any other supreme law of the land. The determination does not require a prior court ruling on identical facts; it is the substance of the conduct against the substance of the cited constitutional authority that controls. See §1.1.1.10 (Logical Consistency) and Section 16 (Nullity of Repugnant Instruments).

**Unlawful.** Conduct that violates any constitutional, statutory, regulatory, or common-law rule binding on the actor. Unlawful is broader than unconstitutional; it includes any violation of binding law, not only constitutional violations. A government actor's conduct may be unlawful without being unconstitutional in every case, but conduct that is unconstitutional is always also unlawful.

**Ultra vires.** Conduct outside the lawful scope of the actor's office, role, contract, appointment, commission, delegation, or other source of authority. A government actor acts ultra vires when:
...
**Malicious.** As defined and graduated in Section 3 (Mens Rea: Criminal and Civil) and §1.1.16 (Mental-State Terms): intentional conduct accompanied by ill will, hatred, evil motive, retaliatory purpose, desire to punish, desire to intimidate, desire to conceal wrongdoing, or desire to harm a citizen. Malicious conduct triggers maximum aggravation under §3.5 and is reachable as the highest mens rea tier wherever malice is shown.

**Retaliatory.** Conduct undertaken because of, motivated by, or substantially influenced by another person's status as a whistleblower, complainant, journalist, critic, political opponent, witness, Citizen Council member, or person exercising a right protected under §1.1.5. Retaliatory conduct is reachable as an offense under §17.2 (Institutional Retaliation), §17.2A (Process-Stacking Retaliation), §17.2B (Retaliatory Charge Fabrication), and the wrongful-conviction conspiracy provisions of §2.5.3, among other provisions.

**Fraudulent.** Conduct involving intentional misrepresentation of fact, concealment of material fact required to be disclosed, deception, false documentation, false swearing, or knowing reliance on false evidence — where the misrepresentation is material and made with intent to deceive or in reckless disregard of truth. Fraudulent conduct is reachable under §17.4 (Deliberate Record Distortion), §17.6 (Public Trust Fraud), §1.1.14 (Malicious Prosecution), and §2.6.2.4 (False Representation to the Court), among other provisions.

**Coercive.** Conduct that uses threat, force, intimidation, deception, abuse of authority, exploitation of dependency, or other unlawful pressure to obtain compliance, consent, payment, silence, plea, waiver, or surrender of a right that the citizen would not otherwise give. Coercion may be express or implied, explicit or contextual. Coercive conduct is reachable under §1.1.2 (Assault), §1.1.3 (Battery), §1.1.12 (Terrorism), §1.1.13 (Official Intimidation), §2.6.2.6 (Coercive Plea Bargaining), §2.8.1 (Custodial Rights Interference), and §2.8.6 (Sheriff Custody and Release Obstruction), among other provisions.

**Obstructive.** Conduct that prevents, delays, impedes, conceals, or distorts the lawful operation of a proceeding, investigation, record, duty, or official function in a manner that materially affects the truth-finding or rights-protecting function of the process. Obstructive conduct is reachable under §1.1.8 (Obstruction of Justice) and its subsections, §17.4 (Deliberate Record Distortion), §17.4A (Public-Record Spoliation), §9.9 (Interference with Citizen Council Action), and the repugnant-instrument enforcement provisions of Section 16, among other provisions.

**Outside due process.** Conduct that fails to provide, or actively bypasses, the procedural protections owed to a citizen under Section 2 (Due Process) of this Act, the United States Constitution, the Utah Constitution, or other binding law. "Outside due process" includes conduct that proceeds without notice, without opportunity to be heard, without competent counsel where required, without recording where required, without disclosure of evidence required by §2.6.1.1, without engagement on the merits required by §2.7.1.2, or without any other procedural protection that the law requires before a deprivation of a citizen's rights, liberty, property, family, or livelihood.

#### 1.1.19 Categories of Obviously Wrongful Conduct

The following terms describe categories of conduct that would be plainly criminal, tortious, or otherwise unlawful if committed by a private citizen. Where a government actor engages in any of this conduct under color of authority, the conduct is not made lawful by the actor's official status, by the absence of a prior court case condemning the exact factual pattern, or by any immunity doctrine abrogated under §5.1.1. These terms appear most prominently in §5.1.1 (Obvious Wrongs Require No Fact-Matched Case) and apply throughout this Act. They complement, and do not displace, the boundary terms of §1.1.18.

**Theft.** The intentional taking, withholding, conversion, or use of another person's money, property, or other thing of value, without lawful authority and without the consent of the owner. Theft by a government actor under color of authority — including the taking or conversion of cash, property, contraband, or items during a search, seizure, traffic stop, custodial intake, evidence inventory, civil-forfeiture proceeding, or any other official function — is reachable under §1.1.3 (Battery), §1.1.7 (Government Racketeering), §1.1.6 (Cabalism), and §17.9F (Property Punishment Without Conviction), among other provisions. The doctrine that has shielded such conduct from civil liability (as in *Jessop v. City of Fresno*, 936 F.3d 937 (9th Cir. 2019)) does not apply under this Act.

**Coercion.** As defined in §1.1.18 (Coercive): the use of threat, force, intimidation, deception, abuse of authority, exploitation of dependency, or other unlawful pressure to obtain compliance, consent, payment, silence, plea, waiver, or surrender of a right the citizen would not otherwise give.

**Fabrication.** The creation, alteration, manufacture, planting, or invention of evidence, testimony, reports, records, statements, charging documents, witness identifications, forensic results, or other material — knowingly or with reckless disregard for the truth — for use in any investigation, prosecution, proceeding, official decision, or public communication. Fabrication is reachable under §17.4 (Deliberate Record Distortion), §17.4B (Forensic Truth Corruption), §1.1.14 (Malicious Prosecution), §2.6.2.7 (Witness Manipulation by Prosecutor), and §17.2B (Retaliatory Charge Fabrication), among other provisions.

**Retaliation.** As defined in §1.1.18 (Retaliatory): conduct undertaken because of, motivated by, or substantially influenced by another person's status as a whistleblower, complainant, journalist, critic, political opponent, witness, Citizen Council member, or person exercising a right protected under §1.1.5.

**Violence.** The intentional use of physical force against a citizen, or the threat of imminent use of such force, where the force is not justified by an actual, immediate, and reasonable lawful necessity. Violence includes physical strikes, restraint, pain compliance applied where no resistance exists, use of weapons or instruments, deployment of canines, vehicle ramming, chemical agents used without necessity, and any other force applied beyond what the circumstances actually require. Violence by a government actor is reachable under §1.1.3 (Battery), §17.15 (Reckless Force Deployment), §2.8.11 (Home-Invasion Under Color of Warrant), and §1.1.12 (Terrorism) where the elements are met.

**Intimidation.** Conduct that places, or that the actor knew or should have known would place, a citizen in fear of harm to the citizen's person, family, livelihood, liberty, property, or rights, beyond what any legitimate purpose of the office requires. Intimidation is reachable under §1.1.13 (Official Intimidation), §1.1.12 (Terrorism), §17.2 (Institutional Retaliation), and §2.8.1 (Custodial Rights Interference) where the elements are met.

**Deception.** The intentional misstatement of fact, intentional omission of fact required to be disclosed, or intentional framing of fact in a manner reasonably likely to mislead the listener — including misleading statements by an officer to a citizen during a stop or interrogation, misleading statements by a prosecutor to a jury, misleading statements by a judge in a ruling, misleading statements in an official report, misleading statements on an official form, and misleading statements to the public, to the legislature, or to Congress. Deception is reachable under §17.4 (Deliberate Record Distortion), §17.6 (Public Trust Fraud), §2.6.2.4 (False Representation to the Court), §2.6.2.7 (Witness Manipulation by Prosecutor), §17.25 (Misleading Testimony to Utah's Federal Representatives), and §2.8.1 (Custodial Rights Interference, where deception is used to extract a statement or waiver), among other provisions.

**Evidence destruction.** The intentional destruction, alteration, concealment, deletion, spoliation, overwriting, loss, or failure-to-preserve of evidence — physical, documentary, electronic, recorded, or otherwise — that the actor knew or should have known was material to an investigation, proceeding, complaint, or citizen's rights claim. Evidence destruction is reachable under §17.4 (Deliberate Record Distortion), §17.4A (Public-Record Spoliation), §2.8.3 (Unrecorded Enforcement Contact, where preservation failure is intentional), and §1.1.8 (Obstruction of Justice), among other provisions.

**Sexual exploitation.** The use of a government actor's authority, office, custodial position, supervisory position, or material dependency over a citizen to obtain sexual contact, sexual exposure, sexualized communication, voyeuristic access, romantic involvement, silence or non-reporting concerning sexual misconduct, or any other sexual benefit the citizen would not otherwise give. Sexual exploitation is reachable under §2.8.10 (Custodial Sexual Domination), §17.11 (Badge Coercion, sexual prong), §1.1.3 (Battery), §1.1.12 (Terrorism), and any generally applicable sexual-assault, rape, sexual-misconduct, or sexual-exploitation statute of Utah or other binding law. **No claim of "consent" by a person in custody, detention, supervision, placement, institutional control, or material dependency on the actor exercising power can validly defeat a charge under this term.**

**Family separation.** The removal, restriction of access to, termination of contact with, or any other interruption of the relationship between a parent and child, a spouse and spouse, a guardian and dependent, or other members of a family unit, where the action is not supported by an order issued in accordance with due process, supported by clear and competent evidence, and not procured through fraud, fabrication, perjury, coercion, or pretextual basis. Family separation by a government actor without lawful basis is reachable under §1.1.3 (Battery), §1.1.12 (Terrorism), §17.9I (Poverty-Based Family Separation), §17.9J (Family-Rights Advisement Failure), and any generally applicable kidnapping or unlawful-restraint statute. The fact that the separation was effected through a court order, child-welfare proceeding, immigration proceeding, or other official process does not, by itself, cure the absence of lawful basis where the order or proceeding was procured through fraud, fabrication, or any process that fails the due-process protections of Section 2.

**Deprivation of liberty.** The unlawful restraint, detention, imprisonment, custody, supervised release, electronic monitoring, restriction of movement, restriction of association, restriction of residence, or any other restriction on a citizen's lawful freedom of movement, association, or self-determination — where the restraint is not supported by lawful authority, lawful process, and the constitutional and statutory protections owed to the citizen under Section 2 (Due Process). Deprivation of liberty by a government actor without lawful basis is reachable under §1.1.3 (Battery), §17.14 (Enforcement Without Articulable Basis), §2.8.1 (Custodial Rights Interference), §2.10.3 (Wealth-Based Liberty Denial), §2.8.6 (Sheriff Custody and Release Obstruction), §2.8.8 (Technical-Violation Incarceration Abuse), and §1.1.12 (Terrorism) where the elements are met. The duration of the deprivation, the formality of the process used to effect it, the title of the official imposing it, or the existence of a facially valid order does not, by itself, transform an unlawful restraint into a lawful one.

#### 1.1.20 Incompetence in Office (Citizen-Prompted Oath and Authority Recitation)

> A government actor commits **incompetence in office** under this subsection where the actor, prompted in good faith by a private citizen during the actor's performance of public duties, is **unable to substantially recite** — in the actor's own words or in the operative substance of the text — each of the following:
>
> **(a)** the **oath of office** the actor took or is bound by, in the office under which the actor is acting;
> **(b)** the substance of the **Supremacy Clause** (Article VI, Clause 2 of the United States Constitution);
> **(c)** the substance of the controlling provisions of the **United States Constitution** and the **Constitution of the State of Utah** that are relevant to the power the actor is exercising; and
> **(d)** the substance of the **statute, ordinance, regulation, court order, or other lawful source of authority** the actor is invoking, asserting, or exercising in the interaction with the citizen.

**Substantial Recitation Defined.**

"Substantially recite" means stating the operative substance of the item, not necessarily verbatim. The actor need not produce a memorized quotation. The actor must demonstrate **working knowledge** sufficient to show that the actor knows what they swore, what they are bound by, and what they are exercising power to do at that moment.

**Classification.**

- Incompetence in office under this subsection is a **Class 1 misdemeanor** ("high misdemeanor" in the colloquial sense).
- Inability to substantially recite the items listed in (a) through (d) is **prima facie evidence** of the offense.
- A finding under this subsection renders the actor **temporarily incapable of acting in that office** until the actor (i) demonstrates working knowledge of the items listed above to a competent reviewing authority, and (ii) completes mandatory remedial constitutional and statutory-authority training. Acts performed in the office during the period of temporary incapacity are reachable under §1.1.10 (Anarchy) and §1.1.18 (Ultra Vires).

**Procedure — Immediate Recitation Required.**

- The citizen states the request clearly and identifies it as an incompetence-in-office prompt under this subsection.
- The actor shall attempt the recitation of (a) through (d) **immediately, in real time, from memory and the actor's own working knowledge**.
- The **only** exception is an **active emergency** — a gunman, an active medical crisis, an active pursuit, a fire actively being suppressed, or any other event in progress that must be immediately settled before the actor can give attention to anything else. Where an active emergency is in progress, the recitation is deferred only until the emergency is settled, at which point it shall be performed immediately and without further delay. "Active emergency" does not include ordinary office duties, paperwork, routine patrol, queue of unrelated work, supervisor preference, scheduling inconvenience, or any other condition short of an event that must be settled at that moment.
- The request and response shall, where practicable, be recorded by the citizen, the actor, or both. The recording is admissible under §2.3 (Hearsay and Equal Use of Statement Evidence).
- Where the actor fails the recitation, the citizen may file the resulting record with the prosecuting office, a Citizen Council under §9, or any other competent authority for charging under this subsection.

**Reliance on Materials Is Itself Prima Facie Evidence of the Offense.**

> If the actor consults, reads from, looks at, references, or otherwise relies on any external materials — notes, a card, a manual, a phone, a body-camera screen, a vehicle terminal, a colleague's statement, an internet search, written law, or any other source — to perform the recitation, that reliance is **itself prima facie evidence of incompetence in office** under this subsection.

The purpose of the recitation is to demonstrate the actor's **own** working knowledge of the oath, the Supremacy Clause, the constitutional provisions in play, and the statutory authority being exercised. An actor who must consult external materials to identify those items has, by that demonstration, failed to maintain the working knowledge that public office requires of a person exercising state power over a citizen in real time.
...
- Does not apply where the actor is performing a function that, by law, requires no oath and invokes no specific statutory authority.

**Defenses Limited.**

- Lack of recent rehearsal of the oath is **not** a defense.
- Reliance on the oath being "on file" or otherwise documented is **not** a defense.
- A claim that the actor was "too busy" is not a defense where no active emergency is in progress at the moment of the prompt.
- A claim that the actor "knows the law" but cannot articulate it in plain language to the citizen is **not** a defense; the purpose of this subsection is to ensure officials exercising state power can demonstrate the lawful basis of that power at the moment they are exercising it.
- Reliance on the assumption that "this is what we have always done" is not a defense; the actor must demonstrate the actual constitutional and statutory basis, not the actor's institutional habit.
- The need to consult notes, a manual, a phone, a colleague, or any other external source to perform the recitation is **not** a defense — it is the offense itself.

**Relationship to Other Provisions.**

- This subsection operates as a **specific, citizen-triggered** form of incompetence in office. Where the conduct of an actor over time, or in a more general pattern, meets the broader incompetence-in-office offense of §17.5A (which graduates from misdemeanor up to capital based on the harm caused), the actor may be charged cumulatively under both this subsection and §17.5A.
...
This section establishes due-process protections that control criminal proceedings within the scope of this Act. Any statute, rule, procedure, custom, jury instruction, court practice, or government instrument that contradicts this section is superseded, overruled, and void to the extent of the contradiction.

If any provision of this section requires constitutional force to operate fully under the Constitution of the State of Utah, this section shall be construed and enacted as an amendment to that Constitution to the maximum extent permitted by law. Greater protections for an accused person, convicted person, juror, or citizen are preserved; lesser or conflicting protections are displaced.

### 2.1 Affirmative Protections of Due Process
...
Because government is of laws and not of men, no government actor may replace law with personal belief, office custom, departmental policy, institutional convenience, or obedience to a superior. Men are fallible. Offices are fallible. Courts are fallible. Policies are fallible. The controlling law is the Constitution, this Act, and lawful rules made consistently with them.

This is why the mens rea rules of Sections 3 and 4 reject ignorance, subjective uncertainty, policy reliance, and office custom as defenses for government actors. A government actor who exercises state power has an affirmative duty to know, check, and obey the legal limits of that power.

#### 2.1.1 Policy Is Not a Defense

Internal policies, departmental guidelines, institutional practices, local customs, training habits, office norms, software workflows, supervisor instructions, or informal "how we do things here" practices shall not be considered a defense to violations under this Act.

#### 2.1.2 Affirmative Duty to Follow Law

Failure to perform an affirmative duty under this subsection is **failure to serve** and is criminally enforceable. Where a more specific section of this Act defines the duty, elements, or classification, that specific section controls. Where no specific classification is stated elsewhere, the default classification is a **Class 3 felony**.

**Elements of Failure to Serve Under This Subsection:**

The elements are:

1. An affirmative duty existed by statute, constitution, this Act, oath, office, role, court order, lawful policy, controlling law, or the nature of the government power being exercised;
...
### 2.2 Constitutional Rights in Government Context
...
#### 2.2.1 Speech, Conscience, Opinion, and Official Power
...
#### 2.2.2 Privacy, Search, Seizure, and Public Records
...
### 2.3 Hearsay and Equal Use of Statement Evidence

#### 2.3.1 Purpose

This subsection fixes the hearsay gap.

The ordinary hearsay doctrine grew from a real concern: an out-of-court statement may be unreliable because the original speaker is not present, not under oath, and not available for cross-examination. That concern is legitimate when applied honestly.

But the doctrine has often operated unevenly. Statements made by a citizen are frequently admitted against the citizen as admissions, confessions, statements against interest, background facts, officer testimony, recorded statements, business records, jail calls, texts, emails, or other exceptions. Meanwhile, similar statements offered by the citizen for defense, mitigation, impeachment, context, innocence, coercion, bias, or government misconduct are often excluded as "hearsay."

This asymmetry also damages cross-examination. When the state is allowed to build its prosecution through hearsay, summaries of statements, reports about what someone said, officer descriptions of interviews, or selective fragments of out-of-court speech, but the defendant is not allowed to present comparable hearsay to explain, contradict, contextualize, impeach, or defend against that material, cross-examination becomes unreliable. The defendant is forced to fight a partial representation of truth while being denied the statement evidence needed to expose the partiality.

This Act rejects one-way hearsay. If a statement can be used as ammunition against a citizen, the same kind of statement can be used by the citizen, the defense, a claimant, a Citizen Council, or any proceeding under this Act where it tends to show innocence, mitigation, context, government misconduct, bias, retaliation, coercion, unreliability, penalty enhancement, or a protected right.

#### 2.3.2 Representation of Truth; Testimony Is Also a Report

For purposes of this Act, a spoken or written statement is a **representation of truth**, not truth itself. That is true whether the statement is made in court or out of court.

When a witness testifies, *"I heard him say that,"* the witness is testifying to a fact: that the witness heard the statement. The trier of fact may still decide whether the witness is credible, whether the statement was actually made, what the statement meant, whether the original speaker was truthful, and how much weight the statement deserves.

The same is true of ordinary testimony. A witness who says *"I saw it happen"* is also giving a representation of perceived truth. The testimony is evidence, not reality itself. The law may test it through oath, cross-examination, contradiction, corroboration, impeachment, logic, and jury evaluation, but it is still a human report.

Because all testimonial evidence is a human representation of truth, hearsay may not be treated as categorically worthless for the citizen and categorically useful for the government. Reliability is a question of weight, context, corroboration, confrontation, and fairness — not a one-way label.

#### 2.3.3 Equal Use Rule

In any criminal, civil, administrative, Citizen Council, conviction-review, penalty-enhancement, or other proceeding under this Act:

- A statement category admitted against a citizen shall be equally available to the citizen when offered for defense, mitigation, impeachment, context, innocence, explanation, or proof of government misconduct
- A statement category admitted for the government shall be equally available against the government, a government actor, a government body, or a contractor exercising delegated public power
- A court may not admit an out-of-court statement because it helps the prosecution while excluding a materially similar out-of-court statement because it helps the defense
- A court may not treat a citizen's words as reliable when used against the citizen and unreliable when used for the citizen
- A court may not treat government records, police summaries, officer testimony about statements, agency notes, jail calls, recorded statements, text messages, emails, dispatch logs, interview summaries, or official reports as reliable for prosecution while treating comparable defense evidence as inadmissible hearsay

The controlling principle is symmetry: hearsay rules may test reliability, but they may not create a government advantage.

#### 2.3.4 Defense-Favorable Statement Evidence

The following statement evidence is admissible when offered by a citizen, accused person, claimant, defense counsel, Citizen Council, or other non-government party to show innocence, mitigation, context, unreliability, rights violation, government misconduct, retaliation, coercion, bias, penalty enhancement, or any defense recognized by law:

- A statement heard by a witness
- A prior statement by a witness, victim, government actor, investigator, informant, complainant, or third party
- A statement by a government actor, agency employee, contractor, jail official, officer, prosecutor, judge, clerk, or public servant
- A statement in a government record, police report, dispatch log, body-camera recording, jail call, agency note, email, text message, letter, form, database entry, or official communication
- A statement showing fear, confusion, distress, coercion, motive, bias, retaliation, pressure, intimidation, family threat, suicidal ideation, psychological harm, or state of mind
- A statement explaining why a citizen acted, refused consent, fled, complied, froze, remained silent, invoked rights, signed a document, entered a plea, failed to appear, missed a deadline, or appeared confused
- A statement tending to show that a government actor knew, should have known, ignored, concealed, distorted, or recklessly disregarded facts relevant to a citizen's rights

This subsection applies whether the statement is offered for the truth of the matter asserted, for the fact that the statement was made, for notice, for state of mind, for motive, for context, for impeachment, for pattern, for corroboration, or for any other logically relevant purpose.

#### 2.3.5 Government Admissions and Public-Power Statements

For purposes of this Act, a statement by a government actor concerning official conduct, public duty, investigation, enforcement, custody, prosecution, adjudication, records, policy, training, supervision, funding, discipline, or rights compliance is admissible against:

- The speaker
- The speaker's office or agency
- Any government body responsible for the actor's authority
- Any government actor who adopted, repeated, relied upon, concealed, failed to correct, or acted upon the statement

The government may not claim that a government actor's statement is merely private, informal, unauthenticated, or unofficial where the statement concerns public power, official conduct, or the rights of a citizen affected by that power.

#### 2.3.6 No One-Way Exception

No hearsay exception, exemption, doctrine, custom, evidentiary shortcut, or officer-testimony practice may operate only in favor of the prosecution or government.

If the prosecution may introduce a citizen's out-of-court statement as an admission, then the citizen may introduce relevant out-of-court statements by government actors, witnesses, alleged victims, informants, officers, agencies, or third parties when those statements support the citizen's defense or show government misconduct.

If the government may use a statement to prove guilt, knowledge, motive, identity, intent, state of mind, course of conduct, notice, context, or absence of mistake, then the citizen may use comparable statement evidence to prove innocence, lawful motive, fear, confusion, coercion, self-defense, necessity, rights invocation, retaliation, bias, misconduct, lack of intent, or reasonable doubt.

#### 2.3.7 Confrontation, Reliability, and Weight

This subsection does not abolish the right of confrontation. Where the Constitution requires confrontation before testimonial hearsay may be used against an accused citizen, that constitutional protection remains fully in force.

This subsection prevents confrontation and hearsay doctrines from being inverted into a shield for the government. A citizen may waive confrontation as to defense-favorable evidence the citizen offers. The government may not invoke the citizen's confrontation right to block the citizen from presenting defense evidence.

Courts may still consider reliability, prejudice, confusion, fabrication risk, cumulative proof, and authentication, but those concerns must be applied evenhandedly. Where reliability concerns exist, the preferred remedy is disclosure, cross-examination, limiting instruction, weight assessment, corroboration inquiry, or continuance — not categorical exclusion that benefits the government.

#### 2.3.8 Criminal Classification for One-Way Hearsay Suppression

A government actor commits **one-way hearsay suppression** where the actor knowingly or recklessly:

- Argues, rules, instructs, trains, or enforces that a category of statement evidence is admissible when used against a citizen but inadmissible when used for the citizen
- Excludes, suppresses, discourages, mislabels, conceals, or threatens sanctions over defense-favorable statement evidence while using materially similar statement evidence for prosecution or government advantage
- Invokes hearsay to block evidence of innocence, mitigation, coercion, bias, retaliation, psychological harm, suicidal ideation, government misconduct, official notice, or rights violation while relying on comparable hearsay against the citizen
- Instructs a jury, Council, agency, or trier of fact to disregard defense-favorable statement evidence solely because it is hearsay, while allowing comparable government-favorable statement evidence

**Classification:**

- One-way hearsay suppression is a **Class 3 felony**
- Where the suppression affects charging, plea negotiations, conviction, custody, probation, parole, family separation, loss of housing, loss of livelihood, denial of benefits, or penalty enhancement, the offense is a **Class 2 felony**
- Where the suppression contributes to wrongful conviction, prolonged incarceration, death in custody, capital sentence, suicide, or serious bodily injury, the offense is a **capital offense**, and Section 12 applies where the elements are met
- The offense may be charged cumulatively with obstruction of justice, malicious prosecution, deliberate record distortion, public-record spoliation, judicial recklessness, constructive denial of counsel, or any other applicable offense under this Act

#### 2.3.9 Construction

This subsection shall be construed broadly in favor of the citizen's ability to present evidence and against one-way evidentiary doctrines that advantage public power. A statement's status as hearsay affects weight and testing; it shall not be used as a selective weapon to prevent the citizen from telling the whole truth.

### 2.4 Right to Defense Context
...
A juror, and a jury collectively, are entitled to render any of the following verdicts. The court shall instruct that each is a **lawful and complete verdict**, and shall not refuse to accept any of them on the ground that some other verdict was the only "correct" or "available" option:

1. **Guilty** — finding that the elements of the offense have been proven beyond a reasonable doubt
2. **Guilty with Refinement** — finding the defendant guilty, but with the juror's written refinement of the offense (e.g., guilty of a lesser included offense, guilty only of part of the conduct charged, or guilty of conduct of a lesser legal character than alleged), set out in the documentation required by Section 2.5.2
3. **Guilty and Forgiven** — finding that the conduct occurred, but exercising the juror's conscience to **forgive the act and acquit**; equivalent to jury nullification with affirmative forgiveness
4. **Innocent** — finding the defendant not guilty
5. **Unequivocally Innocent** — an affirmative finding of **actual innocence**, with the consequences set out below
6. **Acquittal Without Stated Reason** — declining to convict for any reason or no reason; **no juror is required to explain or justify a vote to acquit**

**Effect of "Guilty and Forgiven" and "Unequivocally Innocent":**

- A verdict of **Guilty and Forgiven** results in **immediate acquittal**. The defendant shall not be punished, and the verdict shall **not be used** as the basis for any civil judgment, professional sanction, deportation consequence, or other collateral consequence
- A verdict of **Unequivocally Innocent** is a finding of actual innocence and shall:
  - Result in **immediate acquittal**
  - **Bar any retrial**, civil suit based on the same conduct, or professional sanction based on the same conduct
  - Trigger review of the prosecuting office's conduct under Sections **1.7 (Government Racketeering)** and **1.8 (Obstruction)** where the prosecution was brought without sufficient basis, and may support **reckless prosecution** charges under Section 2.5.2

**Right to Refuse Group Deliberation:**

> No juror is required to participate in deliberation with other jurors. A juror may choose to **deliberate alone**, in writing, and to render a verdict without engaging in joint discussion.

The reason: group deliberation, while permitted, can **distort a juror's perception of the evidence** through peer pressure, misrepresentation of evidence by other jurors, social conformity, or coercion. A juror's first duty is to the truth as they perceive it from the evidence — not to consensus with their fellow jurors.

- A juror who chooses to deliberate alone shall **not be removed** from the jury, denied a vote, or otherwise penalized for that choice
- A juror who chooses to deliberate alone shall still complete the documentation required by Section 2.5.2
- A juror who chooses to deliberate in group with some, but not all, other jurors retains all rights under this subsection

**Right to a Separate, Private Deliberation Space:**

- Each juror who wishes to deliberate alone shall be provided a **separate, private space** sufficient to review evidence, examine the trial record, and prepare written documentation
- Where a jury wishes, **a separate room shall be available for every juror** who requests one
...
- Removal of a juror for disagreement, vote-splitting, or "holdout" status is a violation of this title
- A judge who removes a juror for disagreement engages in **reckless prosecution** under Section 2.5.2 and is independently chargeable
- A juror's refusal to agree, refusal to deliberate jointly, or refusal to change a vote is **not** a basis for mistrial, removal, replacement with an alternate, or any disciplinary action against the juror
- A juror who is improperly removed retains a civil cause of action under Section 10 against the judge, the prosecuting office, and any other actor responsible for the removal

**Mandatory Instruction by the Court:**

The court shall, in plain and clear language, instruct every jury at the outset of trial and again before deliberation:
...
- Of the **documentation requirement** under Section 2.5.2

> Failure of the court to give this instruction is itself a violation of this title and **renders any subsequent conviction subject to vacatur** under Section 2.5.2. A judge who fails or refuses to give this instruction commits **reckless prosecution** under Section 2.5.2.

**Override of Prior Jury Procedure:**

This subsection, like Section 2.5.2, **overrides and supersedes** all previous process, procedure, custom, rule, instruction, and practice governing how jurors operate, deliberate, vote, or are removed from criminal juries within the scope of this title. Conflicting rules of criminal procedure, jury instructions, court rules, and judicial practices are of no force or effect; greater protections for the accused or for jurors under other law are preserved.

#### 2.5.2 Juror Duties; Mandatory Documentation and Validity of Conviction

> No conviction in any criminal proceeding prosecuted by the state, county, or municipality shall be **legitimate or enforceable** unless each juror who voted to convict has personally executed a **written record** of their decision-making, addressing each item of evidence presented at trial. **This requirement overrides any contrary provision of state or federal procedure, custom, rule, or practice.**

**Rationale:**

A conviction returned without juror documentation deprives the accused of the **right to appeal on the facts** — a fundamental right of every accused and convicted person — by leaving no record of the factual basis on which each juror reached the verdict. The right to factual appellate review cannot be honored when the factual reasoning of the convicting jurors is unrecorded and unexaminable.

**Documentation Required of Each Convicting Juror:**

Each juror who votes to convict shall, before the verdict is returned and entered, prepare and sign a written record that:

- States the verdict and the offense(s) on which the juror voted to convict
- Lists, by reasonable description, **every item of evidence** presented at trial — testimony, documents, exhibits, demonstrations, recordings, and physical evidence
- Provides the juror's **individual comment, evaluation, or weighing of each item of evidence**
- States the juror's reasoning for finding the elements of the offense **beyond a reasonable doubt**
- Identifies any item of evidence the juror found unpersuasive, ambiguous, contradictory, or troubling, and explains why the juror nonetheless voted to convict

The juror's documentation may be in narrative, structured, or any other comprehensible written form. Length, formality, and style are at the juror's discretion, provided the documentation is responsive to each item of evidence.

**Time and Resources:**

- The juror shall be afforded **as much time as required** to complete the documentation, **no matter how long it takes**, regardless of administrative inconvenience to the court, the parties, or the jury
- The court and the parties shall not pressure, rush, hurry, or limit the juror's documentation efforts
- Adequate writing materials, breaks, meals, accommodations, and access to the trial record (transcripts, exhibits) shall be provided
- A juror's request for additional time or for re-examination of evidence is **presumptively reasonable** and shall be granted

**Effect of Non-Compliance:**

> A conviction returned without each convicting juror having executed the required written record is **not legitimate, is not enforceable**, and shall be **vacated on direct or collateral review**.

- The accused or convicted person may raise non-compliance under this subsection at any time, in any post-conviction proceeding, including under Section 10 (Retroactive Civil Applicability) and Section 10.3 (No Statute of Limitations)
- A conviction vacated under this subsection shall not bar retrial, but any retrial is subject to all procedural requirements of this subsection

**Juror Eligibility:**

A person who is **unable or unwilling** to perform the documentation required by this subsection — whether due to illiteracy without reasonable accommodation, cognitive limitation, language barrier without provision for translation, or refusal to undertake the task — is **ineligible to serve as a juror** in any criminal proceeding prosecuted by the state, county, or municipality.

- **Voir dire** shall include inquiry into each prospective juror's ability and willingness to perform the documentation requirement
- A prospective juror who cannot or will not perform the requirement shall be **excused** from the criminal jury venire
- Reasonable accommodations (translation, scribe assistance for physical disability, etc.) shall be made; refusal of an accommodation that would enable the juror to perform the requirement renders the juror ineligible

**Judicial Liability — Obstruction of Justice:**
...
> This subsection **overrides and supersedes all previous process, procedure, custom, rule, instruction, and practice** governing how jurors operate, deliberate, document, or return verdicts in any criminal proceeding prosecuted by the state, county, or municipality.

- Any state or federal rule of criminal procedure, jury instruction, pattern instruction, court rule, local rule, or judicial practice that conflicts with this subsection is **of no force or effect** with respect to criminal proceedings within the scope of this title
- This includes, without limitation, rules permitting general (un-itemized) verdicts, rules limiting juror note-taking or written work product, rules treating jury deliberations as closed to written record, and rules constraining the time available for deliberation or documentation
- Where a state or federal rule provides **greater** procedural protection to the accused than this subsection requires, that greater protection is preserved; only conflicting rules that **diminish** the protections of this subsection are overridden
...
**Conduct reachable under this title:**

A juror is liable under this title where the juror, in voting on or joining a verdict:

- **Convicts a person whom the juror knew, or in reckless disregard of clear evidence should have known, was otherwise innocent** of the offense charged; **or**
- Acts with reckless disregard of the evidence presented at trial in joining a verdict to convict; **or**
- Coordinates, conspires, or agrees with one or more other jurors to convict regardless of the evidence

For purposes of this subsection, "verdict" includes any jury act that authorizes or materially advances criminal accusation, prosecution, detention, conviction, punishment, or deprivation of rights, including a grand-jury vote to indict, return a true bill, refuse to consider exculpatory evidence, or otherwise initiate or continue prosecution.

**Federal and Grand Jury Application:**

This subsection applies to **state and federal grand juries**, **state and federal petit juries**, and any other jury body where:

- The accused, target, defendant, witness, victim, or affected citizen is a citizen of Utah; **or**
- The jury's action causes legal, financial, custodial, reputational, family, immigration, property, or rights-related consequences within Utah; **or**
- The juror's conduct contributes to a violation of this Act against a citizen of Utah.

Where a federal grand jury, federal petit jury, state grand jury, or state petit jury acts against a citizen of Utah, each juror has a duty to document the evidence and testimony relied upon with the same seriousness required by Section 2.5.2. That documentation duty includes each material item of testimony, each exhibit, each representation made by a prosecutor or government witness, and each item of exculpatory or contradictory evidence known to or presented to the jury.

A federal forum, federal label, federal prosecutor, federal courthouse, or federal jury designation does **not** immunize a juror from liability under this Act where the juror's conduct harms, targets, burdens, or deprives a citizen of Utah in a manner reachable by this title.
...
- The deliberation-secrecy and non-impeachment-of-verdict doctrines (Federal Rule of Evidence 606(b) and analogous state rules) **shall not bar** prosecution under this subsection
- Juror immunity for honest deliberation does **not** extend to the conduct described here
- "Following the foreman," peer pressure, or desire to reach a verdict are **not** defenses
...
Prosecutors exercise state power over accusation, charging, evidence presentation, plea pressure, dismissal, and punishment. Because a prosecutor's duties directly affect the presumption of innocence and the fairness of criminal proceedings, the duties in this section are due-process duties.

#### 2.6.1 Affirmative Duties of Prosecutors

The duties in this subsection are affirmative and continuing. A prosecutor must perform them without waiting for a defense request, court order, appellate reversal, or post-conviction discovery.

##### 2.6.1.1 Duty to Disclose Adverse Evidence
...
###### 2.6.1.1.1 Failure to Disclose; Obstruction of Justice
...
##### 2.6.1.2 Duty to Seek Reduction or Dismissal
...
###### 2.6.1.2.1 Failure to Seek Reduction or Dismissal
...
- A Citizen Council under Section 9 may investigate and file a Joint Declaration of Prosecution against any prosecutor for failure under this section
...
#### 2.7.1 Affirmative Duties of Judges

The following duties make **judicial impartiality, engagement, and procedural integrity criminally enforceable** rather than merely aspirational.

A judge's role under this title is **not** to rubber-stamp the requests of prosecutors, police, officers, agencies, or the executive. It is to **decide cases on their merits** — applying the law as written to the evidence as presented, with rigor, impartiality, and due process. A judge who abdicates that role through bias, neglect, ex parte communications, refusal to recuse, or selective application of the law is reachable under this title. Judicial immunity does **not** apply (Section 5.1.1).

> The robe is not a license. It is a constraint.

These duties operate alongside the existing judicial-conduct provisions of this title — including the abrogation of judicial immunity in Section 5.1.1; the reckless-prosecution liability of Section 2.5.2 (Mandatory Juror Documentation) and Section 2.5.1 (Juror Rights); the no-judicial-gatekeeping provisions of Sections 9.4 and 9.9; and the Logical Consistency Review duties of Section 9.14.

##### 2.7.1.1 Judicial Duty of Impartiality and Recusal
...
- Where the communication is **intentional**, the conduct is elevated to a **Class 2 felony** per Section 3
- Where committed with **malice** or as part of a **pattern**, the conduct is elevated to a **capital offense** per Section 3
- A judicial ruling materially influenced by a prohibited ex parte communication is presumptively subject to vacatur

##### 2.7.1.4 Judicial Duty to Apply Mandatory Rules and Correct Errors
...
- The juror documentation requirements of **Section 2.5.2**
- The juror rights, verdict options, and instruction requirements of **Section 2.5.1**
- The disclosure obligations imposed on prosecutors under **Section 2.6.1.1**, and the court's role in enforcing them
- The four-level mens rea framework of **Section 3**
- The no-immunity provisions of **Section 5.1**
- The Citizen Council mechanisms of **Section 9**, including the no-judicial-gatekeeping rule of §9.4 and the Logical Consistency Review duty of §9.14
- The mandatory prosecution provisions of **Section 9.5** (where a Joint Declaration of Prosecution has been filed)
...
- Where the failure is intentional, the conduct is elevated to a **Class 2 felony** per Section 3
- Where committed with malice or as part of a pattern, the conduct is elevated to a **capital offense** per Section 3
- The doctrine of judicial immunity does not apply, consistent with Section 5.1
- A Citizen Council under Section 9 may investigate and file a Joint Declaration of Prosecution against any judge for failure under this section
...
Officers exercise state power through investigation, detention, search, seizure, force, citation, arrest, interrogation, reporting, and referral. Because officer conduct often creates the facts and records that later control prosecution and judicial action, the duties in this section are due-process duties.

#### 2.8.1 Custodial Rights Interference
...
#### 2.8.3 Unrecorded Enforcement Contact
...
- Where the missing recording would likely have contained exculpatory or impeachment evidence, prosecutors have disclosure duties under §2.6.1.1
...
#### 2.8.5 Citizenship-Claim Detention Obstruction
...
### 2.10 Court Access and Counsel

The offenses of this subsection protect a citizen's access to the courts, to counsel, to the public record, and to the practical means of asserting rights before any government decisionmaker. They apply to judges, magistrates, clerks, court administrators, bailiffs, self-help center staff, filing-office staff, public-meeting administrators, election officials, public guardians, agency hearing officers, and any other government actor whose conduct affects a citizen's practical access to court process, counsel, or public records.

#### 2.10.1 Court Access Burdening
...
#### 2.10.2 Constructive Denial of Counsel Under Color of Law
...
#### 2.10.3 Wealth-Based Liberty Denial
...
#### 2.10.4 Clerk Access Obstruction
...
### 3.1 Two Tracks; Same Culpability Words

This Act uses **two tracks of mens rea**:

1. **Criminal mens rea** — the mental state required to impose criminal liability, criminal classification, and criminal penalties.
2. **Civil mens rea** — the mental state required to impose civil liability, damages, forfeiture, structural remedies, removal remedies, or other non-criminal relief.

The words used for both tracks are the same: **negligent**, **reckless**, **intentional**, and **malicious**. The meaning of each word is the same in criminal and civil proceedings. What changes is the consequence and the burden of proof, not the definition of the mental state.

#### 3.1.1 Reasonable Defined — Government Actor

For purposes of any section of this Act that uses **reasonable** in relation to a **government actor**, **reasonable** means logical, right-minded, constitutionally aware, and capable of checking whether the actor's conduct is actually lawful. Reasonable does **not** mean ordinary office custom, common departmental practice, typical agency behavior, status quo operation, or what most government actors actually do in the same position.

This definition of **reasonable government actor** is separate from the ordinary **reasonable person** standard. A reasonable person standard asks what an ordinary person in the citizen's position would understand, fear, perceive, or do. A reasonable government actor standard asks what a government actor exercising state power actually should have known, checked, perceived, or done because of that actor's office, oath, authority, training, access to law, and constitutional duty.

For purposes of mens rea, **reasonable** means the standard of a government actor who actually should have known the law, duty, risk, contradiction, or constitutional limit because:

- The actor exercised state power over a citizen;
- The actor had an oath, office, role, training, authority, access to law, access to policy, or access to supervision sufficient to check the legality of the act;
- The actor had a duty to compare the contemplated enforcement, order, policy, practice, or omission against this Act, the Constitution of the United States, the Utah Constitution, and any controlling law;
- The illegality, contradiction, risk, or duty was knowable by reason, logic, ordinary legal checking, the nature of the office, or the obviousness of objective reality.

It is **not** a defense that no actual officer, judge, prosecutor, agency employee, or government actor in the same office commonly performs that constitutional check. By the nature of the word, **reasonable** means logical, right-minded, and grounded in lawful thinking; it does not mean the current norm, the status quo, or whatever the office usually does. Policy, training custom, office habit, supervisor instruction, or lack of a real-world example does not define what is reasonable under this Act. A government actor who enforces law has an affirmative duty to check whether the enforcement is actually lawful under supreme law, not merely authorized by statute, rule, policy, or habit.

**Reliance on Supreme Court precedent alone is not reasonable where the precedent is logically inconsistent with supreme law, this Act, or other Supreme Court doctrine.** A government actor may use judicial precedent as evidence of legal reasoning, but may not treat a case as a substitute for independent constitutional checking where the doctrine conflicts with the principle that government power is defined and limited.

This rule is necessary because the Supreme Court has itself used conflicting descriptions of government power. For example:

- In *Marbury v. Madison*, 5 U.S. 137 (1803), the Court stated that government powers are **"defined and limited."**
- In *McCulloch v. Maryland*, 17 U.S. 316 (1819), the Court stated that the federal government is **"one of enumerated powers."**
- In *House v. Mayes*, 219 U.S. 270 (1911), the Court stated that state police power **"exists independently of, the federal Constitution."**
- In *Noble State Bank v. Haskell*, 219 U.S. 104 (1911), the Court stated that police power **"extends to all the great public needs."**
- In *Bacon v. Walker*, 204 U.S. 311 (1907), the Court stated that police power reaches **"the greatest welfare of the state."**

These statements cannot all be used as unrestricted grants of authority at the same time. A reasonable government actor must resolve any such conflict in favor of the written Constitution, this Act, protected rights, due process, and the limitation of government power, not in favor of broad police-power language, office convenience, or institutional habit.

### 3.2 Criminal Mens Rea

For criminal enforcement under this Act, the culpability levels are:

1. **Negligent** — the actor failed to exercise reasonable care under the reasonable-government-actor definition of Section 3.1.1 and failed to perceive a substantial risk that the actor actually should have perceived by reason, logic, office, training, authority, circumstances, constitutional duty, or obviousness of objective reality.
2. **Reckless** — the actor consciously disregarded a substantial and unjustifiable risk, ignored a risk that was obvious from the facts, or proceeded while aware that the conduct might violate law, rights, duty, truth, or due process.
3. **Intentional** — the actor acted consciously, purposefully, or deliberately, or acted with awareness that the result was substantially certain to follow.
4. **Malicious** — the actor acted intentionally plus with ill will, hatred, evil motive, retaliatory purpose, desire to punish, desire to intimidate, desire to conceal wrongdoing, or desire to harm a citizen.

Unless a specific offense states a different minimum mental state, the default minimum mental state for criminal liability is **reckless**. Negligent conduct under color of authority may still be criminal where this Act expressly classifies negligence, failure to serve, infractions, or negligent official conduct as criminally enforceable.

**Criminal Classification:**

- Negligent criminal conduct is classified as stated in the specific offense, and where no specific classification is provided, as an **infraction** or **Class 1 misdemeanor** under the negligence rules of this Act.
- Reckless criminal conduct uses the baseline classification stated in the offense.
- Intentional criminal conduct elevates the offense by one tier unless the specific section provides a different classification.
- Malicious criminal conduct elevates the offense by two tiers and triggers maximum aggravation, including capital classification where this Act authorizes capital treatment.

### 3.3 Civil Mens Rea

For civil enforcement under this Act, the same culpability levels apply:
...
Civil mens rea supports civil liability, damages, restitution, forfeiture, removal from office, structural reform, injunctive relief, declaratory relief, and any other civil remedy authorized by this Act.

**Civil Consequences:**

- Negligent civil conduct is actionable where it affects a citizen's rights, liberty, property, safety, family, livelihood, due process, access to justice, or access to government process.
- Reckless, intentional, and malicious civil conduct support enhanced civil remedies, structural remedies, forfeiture, and removal remedies where authorized by this Act.
- Civil liability may proceed even where criminal prosecution is not brought, is declined, or does not result in conviction.

### 3.4 Burden and Standard of Proof

- In criminal prosecutions, the prosecution must prove the offense elements and required criminal mens rea **beyond a reasonable doubt**.
- In civil actions, the claimant must prove the offense elements and required civil mens rea by a **preponderance of the evidence**, unless a specific section requires a higher civil standard.
- The same conduct may satisfy both criminal mens rea and civil mens rea. A criminal acquittal does not bar civil liability where the civil standard is met.

#### 3.4.1 Beyond a Reasonable Doubt Defined

For purposes of this Act, **beyond a reasonable doubt** means proof that leaves the trier of fact firmly convinced that every element of the offense and the required criminal mens rea are true.

A doubt is **reasonable** when it arises from reason, logic, evidence, lack of evidence, contradiction, credibility problems, constitutional irregularity, unreliable procedure, or any other fact that would cause a logical and right-minded person to hesitate before authorizing criminal punishment.

A doubt is **not reasonable** merely because it is imaginary, speculative, invented to avoid an unpleasant conclusion, based on sympathy for a government actor, based on hostility toward a citizen, or based on a belief that government actors should be protected from accountability.

The phrase **beyond a reasonable doubt** uses the ordinary trier-of-fact standard. It is separate from the **reasonable government actor** definition in Section 3.1.1. Section 3.1.1 defines what a government actor actually should have known or done; this subsection defines the level of proof required before criminal punishment may be imposed.

### 3.5 No Lesser Mental State as a Defense

> Lack of a higher mental state is **not a defense** to a lower one. A government actor who proves they did not act maliciously is still liable at the intentional, reckless, or negligent level if those elements are met.

A defendant cannot escape liability by establishing only that they did not act maliciously, or only that they did not act intentionally. The Council, prosecutor, claimant, or trier of fact may charge, plead, prove, and find any level supported by the evidence.

### 3.6 Specific Offenses May Require Higher Mental States

Some substantive offenses in this title, by their nature, require a higher minimum mental state as set out in their respective sections. Where a specific offense states a higher minimum mental state, that specific requirement controls for that offense.

### 3.7 Office, Policy, and Orders Are Not a Defense at Any Level

Consistent with Sections 1.10 and 2.A:

- **Internal policy** is not a defense at any mental state level
- **"Following orders"** is not a defense at any mental state level
- **Office, title, or status** is not a defense at any mental state level
- The doctrine of **qualified, judicial, prosecutorial, sovereign, legislative, executive, or governmental immunity** does not apply at any mental state level

## Section 4 — Knowing and Cognate Terms

### 4.1 Knowing Is Not the Same as Intentional

The words **knowing**, **knowingly**, **knew**, **with knowledge**, **should have known**, and similar terms describe the actor's awareness of facts, law, duty, risk, or objective reality. The word **intentional** describes purposeful action or action taken with awareness that a result is substantially certain to follow.

Intentional conduct may use knowing facts as proof, but knowing and intentional are not the same word and shall not be collapsed into one another.

### 4.2 Knowledge Ladder — Low to High Culpability

Wherever the words **"knowingly,"** **"knew,"** **"knowing,"** **"with knowledge,"** **"should have known,"** or any cognate term appears anywhere in this Act, the term shall be construed broadly to include each of the following levels, listed from lower culpability to higher culpability:

1. **Should have known by reason, logic, or obviousness of objective reality** — the fact, duty, unlawfulness, contradiction, risk, or harm was so apparent from ordinary reason, basic logic, common experience, or objective reality that the actor actually should have known it under the reasonable-government-actor definition of Section 3.1.1.
2. **Should have known by nature of office** — the fact, duty, unlawfulness, contradiction, risk, or harm was something the actor actually should have known because of the actor's office, role, oath, authority, training, access to information, professional function, constitutional duty, or duty to check legality under Section 3.1.1.
3. **Ignored a substantial risk** — the actor consciously disregarded, avoided, minimized, or failed to investigate a substantial and unjustifiable risk that the relevant fact, duty, unlawfulness, contradiction, risk, or harm existed.
4. **Actually knew** — the actor in fact knew the relevant fact, duty, unlawfulness, contradiction, risk, or harm.
5. **Full knowledge** — the actor actually knew, had direct notice, documentation, admission, warning, court filing, record evidence, personal participation, or other confirming information, and nevertheless continued, approved, concealed, defended, or failed to correct the conduct.

### 4.3 Effect of Knowing on Criminal and Civil Liability

The knowledge ladder is a gateway to liability. The classification or remedy then maps back to the criminal or civil mens rea framework in Section 3:

| Knowledge Level | Mens Rea Effect |
|---|---|
| Should have known by reason, logic, or obviousness | Negligent or reckless, depending on the obviousness and risk |
| Should have known by nature of office | Negligent or reckless, depending on the office duty and risk |
| Ignored a substantial risk | Reckless |
| Actually knew | Intentional where the actor proceeds despite actual knowledge |
| Full knowledge | Intentional or malicious, and supports maximum aggravation where concealment, retaliation, harm, or continued violation is shown |

### 4.4 No Subjective-Ignorance Defense

It is **not a defense** to any offense under this Act in which "knowingly" or a cognate term is an element that the actor claims not to have reached subjective certainty. The trier of fact may find knowing conduct from objective reality, office duty, obvious facts, ignored risk, actual knowledge, full knowledge, records, warnings, training, communications, or the actor's own conduct.

This section follows the ordinary rule recognized by the Supreme Court in *Cheek v. United States*, 498 U.S. 192 (1991): **"ignorance of the law or a mistake of law is no defense"** to criminal prosecution. *Cheek* recognized a narrow tax-law willfulness issue because federal tax law may be unusually complex for ordinary citizens. That exception does not create a subjective-ignorance shield for government actors exercising state power under this Act.

The rule is also supported by additional Supreme Court decisions:

- In *Barlow v. Eighty-Five Hogsheads of Sugar*, 32 U.S. 404 (1833), the Court stated that **"ignorance of the law will not excuse any person, either civilly or criminally."**
- In *Jerman v. Carlisle*, 559 U.S. 573 (2010), the Court reaffirmed the same common-law maxim and applied it in a civil-liability context.
- In *Reynolds v. United States*, 98 U.S. 145 (1879), the Court distinguished ignorance of fact from ignorance of law, stating: **"but not ignorance of the law."**
- In *Lambert v. California*, 355 U.S. 225 (1957), the Court recognized that **"due process places some limits"** on punishment of passive citizens without notice. That due-process protection does not excuse a government actor who exercises state power and assumes official duties.
- In *Screws v. United States*, 325 U.S. 91 (1945), the Court stated that state officials assume a duty to know basic rights when they assume office, and that **"Ignorance of the law is no excuse."**

A government actor is not an ordinary citizen confronted with unknown law. A government actor exercises delegated public power, acts under oath or office, and has an affirmative duty to know, check, and obey the limits of that authority. Therefore, where this Act uses "knowingly" or a cognate term, the actor may not defeat liability merely by claiming personal uncertainty, failure to research, office habit, policy reliance, or subjective disagreement with the law.

### 4.5 Application — Existing Knowing and Cognate Formulations

This section applies to every appearance of "knowingly" and cognate terms throughout this Act. Where any provision in this Act states a more specific formulation, including the recurring phrase "**knew, or in reckless disregard of clear evidence should have known**," this section is incorporated by reference and supplements, rather than displaces, the formulation in the specific provision.

---

## Section 5 — Liability and Penalty Architecture

This section sets the liability and penalty architecture of the Act. It abrogates the immunity doctrines that have shielded government actors from accountability, holds officials to the heightened public-servant standard demanded by their delegated power, and provides the penalty enhancements that attach to violations of the substantive offenses defined elsewhere in this Act.

### 5.1 Fixing the Immunity Gap
...
#### 5.1.1 Doctrines Creating the Immunity Gap
...
**Judicial Immunity** — the doctrine that a judge cannot be sued, civilly or criminally, for judicial acts within their jurisdiction even where the conduct is malicious, corrupt, or grievously injurious to a citizen — as developed in:

- **Bradley v. Fisher, 80 U.S. (13 Wall.) 335 (1872)** — the foundational case, establishing that judges enjoy absolute civil immunity for acts done within jurisdiction "however erroneous the act may have been, and however injurious in its consequences," and that this immunity is **not lost by allegations that the act was done maliciously or corruptly**
- **Pierson v. Ray, 386 U.S. 547 (1967)** — extending Bradley to civil rights actions under 42 U.S.C. § 1983, holding that judges retain absolute immunity from § 1983 suits even where the judge is accused of acting in **bad faith or with malice**
- **Stump v. Sparkman, 435 U.S. 349 (1978)** — applying absolute judicial immunity to a state judge who, **without a hearing and without due process**, approved a parental petition to surgically sterilize a fifteen-year-old girl. The Court held the judge was absolutely immune from liability, reasoning that "grave procedural errors" do not strip immunity if the act is "judicial in nature" and within general jurisdiction
- **Mireles v. Waco, 502 U.S. 9 (1991)** — per curiam, applying absolute judicial immunity to a judge who **ordered police to physically attack a public defender** with "excessive force." The Court held the order was "judicial in nature" and therefore immune

> The principle these cases establish — that **a judge may act outside the law, even maliciously, even causing grave and irreversible harm to a citizen, and bear no civil or criminal liability** — **ENDS HERE**. Within the scope of this title:
>
> - A judge who commits a violation of any provision of this Act is **personally liable** under this title, civilly and criminally, **regardless** of whether the conduct was "judicial in nature" or "within jurisdiction"
> - Acts that are **deliberate, malicious, in excess of jurisdiction, or in violation of clearly established constitutional rights** are reachable without any threshold immunity inquiry
> - The "clearly established law" test of qualified immunity (see below) **does not apply**
> - A judge who orders unlawful force, who approves orders without due process, who acts in bad faith or with malice, or who otherwise commits any offense defined in this title is **personally liable to the same extent as any other government actor**

**Prosecutorial Immunity** — the doctrine that a prosecutor enjoys absolute civil immunity for acts in their advocate role, even where the prosecutor knowingly used false testimony — as developed in:
...
- **Harlow v. Fitzgerald, 457 U.S. 800 (1982)** — establishing the modern "clearly established law" test
- The extensive line of cases applying that test to shield officers from liability where the specific factual circumstances had not been previously adjudicated

> The "**clearly established law**" inquiry has **no application** under this title. A government actor cannot escape liability by arguing that no previous case had specifically held the same conduct unlawful. The standard is the substantive elements of the offense — recklessness, intent, or malice as defined in Section 4 — not whether some prior court has ruled on identical facts.
...
#### 5.1.2 The Accountability Gap This Act Closes
...
### 5.4 Fixing the Private-Capacity Jurisdiction Gap

> Conversely, a government actor's status as an off-duty or private citizen at the moment of the alleged conduct shall **not** shield the actor from investigation by a Citizen Council under Section 9.10, nor from prosecution for any crime under generally applicable criminal law.

- The Public Servant Status of Section 5.3 limits the **defenses** an actor may raise for **official** conduct
- This Section 5.4 confirms that private-capacity conduct of a government actor remains **fully subject to Citizen Council jurisdiction** under Section 9.10(b) and to prosecution under generally applicable criminal law
- The two principles operate in parallel: an actor cannot use official capacity to expand personal rights, and cannot use private capacity to escape the citizen-accountability mechanisms of this title
- See Section 9.10 for the scope of Council jurisdiction over private-capacity conduct

### 5.5 Fixing the Equal-Application Gap
...
This subsection shall be read together with Sections 2.2 and 5.3. A government actor remains a private citizen when acting outside official power, outside color of authority, and outside any use or reasonable appearance of public office. In that private-citizen capacity, the actor retains the same constitutional rights, defenses, and criminal-liability standards that apply to any other private citizen, subject to Citizen Council jurisdiction under Section 9.10 where applicable.
...
- Abuse of authority, pretense of lawful authority, public office, public title, official appearance, or delegated power may aggravate the offense and support penalty enhancement under §5.6

Election to public office is not a defense, immunity, license, or enlargement of power. An elected official receives only the limited authority lawfully delegated to that office, and no more. The fact that an actor was chosen by voters does not authorize the actor to violate rights, exceed constitutional limits, abuse public power, retaliate against citizens, obstruct enforcement, or treat public office as personal dominion. Rights protected by this Act are enforceable against elected officials by the same civil and criminal mechanisms that apply to every other government actor, including the heightened official-capacity standard described in this subsection.

Nothing in this subsection strips a public official of private-capacity constitutional rights when the official is not acting, appearing to act, or leveraging power as a government actor. This subsection prevents official power from being converted into a personal shield.

### 5.6 Fixing the Penalty Gap

Penalties may be enhanced where:

- The victim is detained, restrained, or unable to leave
- The act is committed under pretense of lawful authority
- Multiple actors participate
- The act results in long-term deprivation of rights
...
#### 5.6.1 Fixing the Psychological-Harm Evidence Gap

Psychological harm under this section may be established by any combination of:

- Testimony of the victim
- Testimony of family members or others with direct knowledge of the victim's state
...
#### 5.6.2 Fixing the Suicide-Charging Gap

Where suicidal ideation under this section progresses to an act of suicide, the conduct shall be charged under **Section 12.1 (Suicide of a Private Citizen)** rather than treated solely as an enhancement under this section.
...
## Section 9 — Activation of Prosecution; Citizen Council and Joint Declaration

### 9.1 Citizen Council Formed Outside the Judicial Process
...
### 9.3 Declaration of Prosecution
...
- Be **signed under oath or affirmation** by each of the twelve (12) or more Council members joining in it
- Be **filed simultaneously** with the **County Prosecutor's Office** of the county where the conduct occurred and with the **Office of the Governor** of the state

No additional pleading, motion, complaint, indictment-by-grand-jury, or judicial finding shall be required for the Declaration to take effect.

### 9.4 No Judicial Officer Required; No Judicial Gatekeeping

> Notwithstanding any rule, regulation, custom, or practice of the **Judicial Conduct Commission** or of any analogous body, a Citizen Council acting under this section **shall not be required to have a judge, magistrate, justice of the peace, or other judicial officer present**, presiding, supervising, or participating in its formation, deliberations, or vote.

No judicial officer, court, or member of the Judicial Conduct Commission shall have authority to:

- Quash, dismiss, set aside, or invalidate a Joint Declaration of Prosecution
- Compel the Council to convene, file, or report through any judicial channel
- Limit the scope of conduct the Council may consider
- Impose pre-Declaration screening, threshold review, or any procedural prerequisite beyond what is set out in this section

### 9.5 Mandatory Prosecution by Designated Office

Upon filing of a Joint Declaration of Prosecution, the matter **shall be prosecuted by**:

- The **County Prosecutor's Office** of the county in which the conduct occurred; **or**
- The **Municipal Prosecutor's Office** of the municipality in which the conduct occurred, where the municipality maintains its own prosecuting authority and the offense falls within municipal-court jurisdiction; **or**
- If the County or Municipal Prosecutor's Office declines, has a demonstrable conflict of interest, or fails to commence prosecution within thirty (30) days of the Declaration's filing, the **Office of the Governor**, which shall designate qualified counsel to prosecute the matter without further delay

The duty of the County or Municipal Prosecutor's Office to prosecute a Joint Declaration is **mandatory**, not discretionary. The prosecuting office's discretion to decline a Declaration-initiated prosecution shall be **limited to**:

- A demonstrable, disclosed conflict of interest, or
- Factual insufficiency apparent on the face of the Declaration

**Policy disagreement, professional courtesy, institutional reluctance, or general prosecutorial discretion shall not constitute valid grounds for declination** of a prosecution initiated by Joint Declaration under this title.
...
### 9.8 Council Declarations; Production, Warrant, and Arrest Authority
...
#### 9.8.1 Declaration of Production of Records
...
Refusal, delay, partial compliance, destruction, alteration, or concealment of materials sought under a Declaration of Production of Records shall constitute interference under Section 9.9.
...
- A Sheriff or deputy who refuses, delays, or fails to enforce a Declaration of Production of Records without a demonstrable, lawful basis commits an act of interference under Section 9.9 and is subject to its penalties
...
### 9.9 No Interference by the State; Obstruction as a Class 2 Felony
...
> A Citizen Council under this title may investigate, and may issue a Joint Declaration of Prosecution against, any government actor for **any crime** alleged to have been committed by that actor — whether **under the color of law** or **in a private capacity** — at the **federal, state, county, or municipal** level. The Council's jurisdiction is not limited to offenses defined within this title, and is not limited to conduct in official capacity.

**Scope of investigable offenses:**

**(a) Conduct under color of law:** Any offense allegedly committed while the actor was operating under the authority, indicia, or apparatus of public office, including but not limited to:

- Offenses defined within this title (including but not limited to Sections 1.2, 1.3, 1.4, 1.6, and 1.7)
- **Federal criminal law**, including Title 18 of the United States Code and any other federal criminal statute (e.g., civil rights violations under 18 U.S.C. §§ 241–242, fraud, racketeering, obstruction, perjury, deprivation of rights under color of law)
- **State criminal law** of any state in which the conduct occurred or had effect
- **County or municipal criminal ordinance** applicable to the conduct

**(b) Conduct in a private capacity:** Any offense allegedly committed by a government actor while **not** operating under the color of law — that is, while acting as a private citizen, off-duty, or outside the scope of their official authority — that would constitute a crime for which any private citizen would be liable, including but not limited to:

- Any federal, state, county, or municipal criminal offense of any classification (felony, misdemeanor, or infraction) under generally applicable criminal law
- Crimes against persons (assault, battery, sexual offenses, domestic violence, homicide, etc.)
- Crimes against property (theft, fraud, vandalism, arson, etc.)
- Driving and traffic offenses of a criminal nature (DUI, vehicular homicide, hit-and-run, etc.)
- Drug, weapons, and other regulatory criminal offenses

**Public Servant Status Cuts Both Ways:**

> Just as a government actor cannot invoke personal rights as a defense to official misconduct (Section 5.3), an actor **cannot invoke off-duty or private-capacity status to escape Council jurisdiction** for conduct that would constitute a crime if committed by any private citizen.

A person clothed with the power and authority of the state remains a person whose criminal conduct — whether committed under color of law or in private life — is a matter of legitimate public concern subject to citizen accountability. The Council's authority under this section follows the **person of the actor**, not merely the **capacity in which the act was performed**.

**Routing of Joint Declarations by jurisdiction:**

- **Federal crimes:** A Joint Declaration of Prosecution alleging conduct constituting a federal offense shall be filed with (a) the **United States Attorney** for the district in which the conduct occurred, and (b) for presentation to a **federal grand jury for consideration of indictment**. Where the U.S. Attorney declines, fails to act within thirty (30) days, or has a conflict of interest, the Declaration may be filed directly for grand-jury presentation through any procedure available under federal law, and the Declaration shall in all events be a public record under Section 9.7
- **State crimes:** A Joint Declaration alleging a state offense (including offenses defined under this title) shall be routed to the County Prosecutor's Office and the Office of the Governor as provided in Section 9.5
- **County or municipal crimes:** A Joint Declaration alleging conduct constituting a county or municipal offense shall be filed with the prosecuting authority for that jurisdiction and concurrently with the County Prosecutor's Office; the fallback to the Office of the Governor under Section 9.5 applies if that authority declines or fails to act within thirty (30) days
...
**Application of Council powers and protections:** Council powers under Section 9.8 (Council Declarations) and protections under Sections 9.6 and 9.9 apply equally to investigations conducted under this subsection — whether the conduct under review was committed under color of law or in private capacity, and regardless of the level of government whose actor is the subject of the investigation.
...
### 9.11 Investigative Authority; Indictment Effect; Filing in State Court

**Investigative Authority of the Council:**

> A Citizen Council under this title has **full investigative authority** with respect to any matter within its jurisdiction under Section 9.10. The Council's powers include, without limitation:
...
- Issuing **Declarations of Production of Records under Section 9.8** to compel production of records, evidence, and effects
- Issuing **Declarations of Warrant under Section 9.8** where private-capacity searches require judicial authorization
- Issuing **Declarations of Arrest under Section 9.8** where arrest authorization is required
- Conducting on-site review of government premises, official records, government devices, public operations, or other official-capacity materials relevant to the investigation, with **Sheriff's Office assistance** under Section 9.8 where necessary to secure access or preserve evidence; private-capacity places, papers, devices, or effects remain subject to the Declaration of Warrant procedure in Section 9.8
...
The Council exercises these powers **independently of, and without supervision by**, any judicial officer, prosecutor, or other government actor, consistent with Section 9.1 and Section 9.4.

**Indictment Effect of the Joint Declaration of Prosecution:**

> A Joint Declaration of Prosecution executed by twelve (12) or more Council members under Section 9.3, and **filed in the appropriate court of competent jurisdiction**, has the **legal force and effect of a grand-jury indictment** for purposes of initiating criminal proceedings under this title or under generally applicable criminal law as identified in Section 9.10.

Specifically:

- The Joint Declaration, once filed in court, **commences the criminal action** without further indictment, presentment, or judicial finding of probable cause
- No additional grand-jury proceeding is required for offenses prosecuted in state, county, or municipal court (federal offenses follow the federal grand-jury routing of Section 9.10)
- The accused is entitled to all procedural protections that would attach to any other indicted defendant (arraignment, bail proceedings, discovery, counsel, trial)
- A court **shall not dismiss, quash, or refuse to file** a Joint Declaration on grounds that it was issued without judicial supervision; such grounds are explicitly addressed and rejected by Section 9.4, and any judicial action contrary to this provision constitutes interference under Section 9.9

**Filing in State Court:**

For state-level offenses (whether under this title or under state criminal law identified in Section 9.10), the Joint Declaration shall be **filed in the state court of competent jurisdiction in the county where the conduct occurred**, in the same manner as any other charging instrument. The clerk of the court shall accept the Declaration for filing without delay; refusal or undue delay by court personnel constitutes interference under Section 9.9.

**Mandatory Prosecution Following State-Court Filing:**

Once a Joint Declaration is filed in state court:

- The **County Prosecutor's Office** of the county in which the conduct occurred shall prosecute the matter; **or**
- Where applicable — that is, where the conduct occurred within a municipality maintaining its own prosecuting authority and the offense falls within municipal-court jurisdiction — the **Municipal Prosecutor's Office** shall prosecute
- The duty to prosecute is **mandatory** under Section 9.5, subject only to the limited declination grounds set out there
- The Office of the Governor fallback under Section 9.5 applies equally when the matter has been filed in state court

**Cross-Reference:**

This subsection clarifies and reinforces — but does not replace — Sections 11.3 (Declaration of Prosecution), 10.4 (No Judicial Gatekeeping), 10.5 (Mandatory Prosecution), 10.8 (Council Declarations), 10.9 (No Interference), and 10.10 (Investigation Scope).

### 9.12 Distribution to Inmates; Inmate Investigative Authority

**Mandatory Distribution to Every Inmate:**

> Every inmate of any federal, state, county, or municipal correctional, detention, jail, or holding facility shall be provided a **printed copy of this statute** at the time of intake or admission to the facility, and shall have continuous access to a copy thereafter.
...
- The statute **shall not be deemed contraband** and shall not be confiscated, removed, withheld, redacted, marked up, defaced, or destroyed by any government actor
- The facility shall post a notice in each housing unit advising inmates of their rights under this title and of the availability of the statute

**Failure to Distribute or Confiscation:**

A government actor or facility that fails to distribute the statute as required, that confiscates or withholds copies, or that retaliates against an inmate for possessing or sharing the statute, commits an act of **interference under Section 9.9** and is subject to the **Class 2 felony** penalty thereof.

**Inmate Investigative Authority:**

> Inmates have the **same investigative authority** under this title as any other citizen. Inmates may form a Citizen Council under Section 9, may issue a Joint Declaration of Prosecution, and may exercise all powers of the Council, including the issuance of Council Declarations under Section 9.8 and the indictment-effect filing under Section 9.11.

**Composition of an Inmate Citizen Council:**

- An Inmate Citizen Council may be composed of **twelve (12) or more inmates** from the same facility, from multiple facilities, or in combination with non-incarcerated citizens
- The conflict-of-interest restrictions of Section 9.2 apply; however, **inmate status itself does not disqualify** any person from Council membership, and a prior or current criminal conviction does not disqualify a person from serving on, or executing a Joint Declaration with, a Citizen Council under this title
- An Inmate Citizen Council may investigate any matter within Council jurisdiction under Section 9.10, including but not limited to conduct by **corrections officers, jail and prison personnel, wardens, prosecutors, judges, parole and probation officers, and any other government actor** affecting inmates or any other citizen

**Special Protections for Inmate Council Members and Participants:**

In addition to the general protections of Section 9.6 and the non-interference provisions of Section 9.9:
...
- The clerk of the court shall accept the Declaration on the same terms as any Declaration filed under Section 9.11; refusal or delay by court personnel or facility personnel constitutes interference under Section 9.9
- An Inmate Citizen Council's Declaration of Production of Records under Section 9.8 shall be served by the **Sheriff's Office** or, where the conduct under review involves the facility itself or its personnel, by an adjacent county's Sheriff's Office, by the State Police, or by such other peace-officer agency as the Office of the Governor may designate, consistent with the conflict-of-interest fallback in Section 9.8

**Scope of Application:**

This subsection applies to every inmate of every facility, including:

- **Pretrial detainees** held in any facility pending trial or hearing
- **Convicted persons** serving any sentence, of any class, in any facility
- **Persons held under civil commitment, immigration detention, juvenile detention, or other custodial status**
- **Persons on probation, parole, or post-release supervision** — with respect to access to the statute, continued participation in Councils formed during incarceration, and the right to form new Councils as non-incarcerated citizens
...
> The minimum age for active participation in a Citizen Council under this title is **fourteen (14) years of age**.

**Active participation requiring age 14 or older:**

- Serving as a member of a Citizen Council under Section 9.2
- Signing a Joint Declaration of Prosecution under Section 9.3
- Signing a Council Declaration under Section 9.8
...
**Persons under fourteen (14):**

- **May** provide testimony, information, or evidence to a Council
- **May** serve as witnesses in any subsequent proceeding
- **May not** sign, vote on, or execute Council instruments
- Are entitled to **all protections of this title** against violations by government actors, regardless of age — the minimum age applies only to active Council participation, not to victimhood, witness status, or any substantive protection

**Application to Inmate Councils:**

This minimum age requirement applies equally to Inmate Citizen Councils under Section 9.12. An inmate under the age of fourteen — including a juvenile detainee — may provide testimony or information to a Council but may not sign or vote on Council instruments.
...
> - Another statute or rule in force, where the inconsistency makes lawful compliance with both impossible.

**Composition:**

- A minimum of **twelve (12) citizens**, drawn from the general citizenry of the jurisdiction whose law is under review
- The conflict-of-interest restrictions of Section 9.2 apply, and additionally exclude any person who drafted, sponsored, voted for, or has a direct financial interest in the statute under review
...
- The Joint Declaration of Logical Consistency Review shall be filed in the **state court of competent jurisdiction**, in the county where the inconsistent law is enforced
- A copy shall be filed simultaneously with the **Office of the Governor** and made part of the public record under Section 9.7

**Mandatory Review by the Court:**

> Upon filing of a Joint Declaration of Logical Consistency Review, the court **shall** convene immediate review of the inconsistent provision and the manner of its application. The review may not be delayed, deferred, or declined except as set out in this subsection.

The reviewing judge **must**:

- Engage with the **substance** of the inconsistency identified by the Council, on the merits
- Issue a **written opinion** explaining whether the inconsistency exists and, if not, providing the reasoning by reference to the actual text of the higher authority and the actual text of the challenged law
- Apply the binding rules of construction in the Statement of Intent (favoring actual reality, the average citizen, and against those who would substitute power for truth)

The reviewing judge **may not** decline review or refuse to nullify on the following grounds:

- **"It's the way it's always been done"** — tradition, custom, or institutional practice alone is **not** a legitimate basis to decline review or to preserve an inconsistent law
- **Stare decisis alone**, where applying stare decisis would itself perpetuate an established logical inconsistency with a higher authority
- **Inconvenience, workload, or administrative cost**
- **Deference** to the legislative body that enacted the law, where the inconsistency is established

**Outcome:**

- Where the inconsistency with the U.S. Constitution, the Utah Constitution, or another in-force statute is established, the challenged provision is **null and void** and shall be **removed from the books** by the appropriate authority within thirty (30) days of the court's order
- Where the court finds no inconsistency, the court shall issue its written opinion explaining the basis; that opinion is itself appealable, and the Council may file again with new findings or additional citizens

**Penalty for Failure to Engage:**
...
### 9.15 Conviction Review (18-Member Council)
...
- The conflict-of-interest restrictions of Section 9.2 apply, and additionally exclude:
...
- **Unanimity is required**: every Council member must sign, under oath or affirmation

**Filing:**

- The Joint Declaration of Conviction Review shall be filed in the **court of conviction** and concurrently with the **Office of the Governor**
- The filing is a public record under Section 9.7
...
- A sparing-from-death-penalty binds the executing authority and any reviewing court
- An extension of public forgiveness restores civil and political rights as set out above, and prohibits the conviction from being used as the basis for any collateral consequence (employment, licensing, immigration, housing, or otherwise)
...
- An 18-member Council action under this section is **final** as to the action taken, but does not preclude additional proceedings to remedy further injustice (e.g., civil action under Section 10 for compensation for wrongful conviction)
...
### 10.1 Civil Cause of Action for Prior Conduct

> Any conduct that would constitute a violation under this statute, whether occurring before or after the effective date of this Act, may be brought as a **civil action** under this title.

### 10.2 Scope

- The retroactive provision of this section applies to **civil suits only**.
- Criminal penalties under this statute apply prospectively, to conduct occurring on or after the effective date.
- A civil action under this section may be brought by the affected citizen, their legal representative, or, where the citizen is deceased, their estate or surviving family.

### 10.3 No Statute of Limitations

> There shall be **no statute of limitations** on any claim, action, or prosecution arising under this title, whether **civil or criminal**.

- A **criminal prosecution** under this title may be commenced at any time after the conduct occurred, without limitation as to time elapsed.
- A **civil action** under this title may be filed at any time, without limitation as to time elapsed.
- This section applies equally to conduct occurring before and after the effective date of this Act, consistent with Section 10.1.
- The retirement, resignation, change of office, or death of the government actor shall **not bar** prosecution or suit. Civil claims survive against the actor's estate for the purpose of recovering forfeited benefits and other monetary remedies under Section 11.
- No doctrine of laches, repose, or analogous time-based equitable bar shall apply to actions under this title.

### 10.4 Excuse-Making and Logical Inconsistency as Prima Facie Evidence
...
### 11.1 Loss of State-Conferred Benefits

> Any government actor found guilty under this title shall **forfeit all benefits derived from the state**, including but not limited to:

- Pensions and retirement benefits funded in whole or in part by the state
- State-funded health and welfare benefits tied to public service
- Accrued service credits and seniority entitlements
- Honors, commendations, and titles conferred by the state
- **Government contracts** held by the actor, by any business entity in which the actor holds a controlling or beneficial interest, or by any entity through which the actor would derive payment, profit, or benefit from public funds
- **Future eligibility for any government contract**, grant, subsidy, license, or award of public funds, whether held individually or through a business entity in which the actor has a controlling or beneficial interest
- Subcontracting arrangements, consulting agreements, or other indirect commercial relationships through which public funds would flow to the actor

### 11.2 Permanent Ineligibility for Positions of State Power

> A person found guilty under this title shall be **permanently ineligible to hold, seek, or be appointed to any position clothed with the power of the state**, including but not limited to:

- Any law enforcement role at any level of government
- Judicial, magisterial, or prosecutorial office
- Regulatory or administrative office with enforcement authority
- Elected public office
- Any contracted role in which the individual would exercise state authority over a citizen
...
## Section 12 — Death of a Citizen Resulting from Violation

### 12.1 Suicide of a Private Citizen

> Where a private citizen takes their own life, and that death is found to be a direct or proximate result of conduct by a government actor that constitutes a violation of this title, the violation shall be a **capital offense**.

### 12.2 Standard of Proof

- The causal connection between the violation and the citizen's death must be established **beyond a reasonable doubt**.
- A capital prosecution under this section requires a finding that the violating conduct was a substantial factor in causing the death.

### 12.3 Procedural Safeguards

- All procedural protections required for a capital prosecution under existing law shall apply, including, without limitation:
  - The right to counsel
  - A bifurcated guilt and sentencing phase
  - Unanimous jury verdict on both guilt and sentence
...
> This Act shall take effect [DATE TO BE DETERMINED]. The civil cause of action under Section 10 shall be available beginning on the effective date for conduct occurring at any time prior.

---

## Section 15 — Constitutional Amendment, Supremacy, and Entrenchment

### 15.1 Effect on the Constitution of the State of Utah

> Where any provision of this Act conflicts with, supplements, or expands upon a provision of the **Constitution of the State of Utah**, this Act shall, upon adoption, **operate as an amendment to the Constitution of the State of Utah** to the extent necessary to give full effect to the provisions of this Act.

This includes, without limitation, provisions of this Act that:

- Establish citizen-led prosecution mechanisms (Section 9)
...
### 15.2 Entrenchment — Protection from Adverse Amendment

> Once adopted, this Act shall **not be amended, altered, repealed, narrowed, or interpreted** in any manner that:
...
> An amendment, alteration, or interpretation violating any provision of this subsection is **void ab initio** — without legal force from the moment of its adoption — and is **not** a defense to any prosecution or claim under this title.

### 15.3 Permitted Amendments

This Act **may** be amended in any manner that:

- **Strengthens** the protections of citizens
- **Expands** the scope of conduct reachable under this title
- **Removes additional immunities** or barriers to citizen access to justice
- **Lowers cost or procedural burden** on citizens seeking redress
- **Increases transparency** of government conduct or the operation of the Act itself
- Adds new categories of government actors, new offenses, or new remedies consistent with the Statement of Intent

> Amendment for the benefit of the citizen is **encouraged**; amendment for the convenience of government actors, institutional defendants, or those who fear accountability is **prohibited**.

### 15.4 Standing to Challenge Adverse Amendments

> Any citizen of Utah has **standing** to challenge, in any court of competent jurisdiction, any subsequent amendment, alteration, repeal, or interpretation of this Act that violates Section 15.2.
...
A Citizen Council under Section 9 may investigate, and may issue a Joint Declaration of Prosecution against, any government actor for the conduct of advancing, sponsoring, or implementing an amendment in violation of Section 15.2. The full powers and protections of Section 9 — including Council Declarations under Section 9.8, the indictment effect under Section 9.11, and the non-interference protections under Section 9.9 — apply.

### 15.6 Construction

This Section is to be construed:

- **In favor of preserving** citizen access to justice and citizen control over government accountability
- **Against** the entrenchment of any privilege, immunity, or institutional protection that this Act removed
- Consistent with the **binding rules of construction** in the Statement of Intent — particularly the principles favoring the average citizen and against those who hold money, power, status, or title used to evade accountability

Where any ambiguity exists as to whether an amendment is "adverse" within the meaning of Section 15.2, that ambiguity shall be resolved **in favor of the citizen and against the proposed amendment**.

### 15.7 Effect on Federal Law; Greater Protection Controls Within Utah; Improper Federal Nullification Reachable Under This Act
...
Consistent with **Section 5.1.1**, the doctrine of judicial immunity (including federal judicial immunity built on *Bradley v. Fisher*, *Pierson v. Ray*, *Stump v. Sparkman*, and *Mireles v. Waco*) **does not apply** to violations of this Act. A federal judge who improperly nullifies this Act is **personally liable, civilly and criminally**, under the relevant offense provisions.

**Citizen Council Jurisdiction Over Improper Federal Nullification:**

A Citizen Council under Section 9 may investigate and issue a Joint Declaration of Prosecution against a federal judge for conduct under this subsection. Routing follows the federal-crime path of **Section 9.10(a)** — filing with the United States Attorney for the district where the judge sits and presenting the matter to a **federal grand jury** for consideration of indictment.
...
These cases stand for the principle this subsection codifies: a federal judge whose conduct in Utah violates **both federal law and the Utah criminal code (this Act)** faces **two separate prosecutions** — one in federal court for the federal offense, and one in Utah state court under this Act — and **neither prosecution displaces the other**. A Citizen Council acting under Section 9 may pursue both tracks concurrently.
...
This subsection accordingly **abrogates** any reading of *In re Neagle*, 135 U.S. 1 (1890), or its progeny that would shield a federal judge from Utah criminal prosecution for conduct within the scope of this Act, consistent with Section 5.1.1's general abrogation of all immunity doctrines for offenses defined in this title.

**Distinction from Legitimate Preemption Analysis:**

This subsection does **not** reach a federal judge who, after engaging with the substance of the Act and the actual federal-state legal framework, correctly identifies a specific provision of federal law that genuinely preempts a specific provision of this Act and rules accordingly.

Good-faith preemption analysis may reduce classification where the judge made a genuine, reasoned effort to apply controlling federal law, but good faith is **not immunity**. A mistaken, unsupported, careless, or overbroad preemption ruling that burdens a citizen of Utah is at minimum an **infraction**, and may be charged as a **Class 1 misdemeanor** where the ruling causes measurable harm, blocks access to process, or continues after the error is identified. Reckless, intentional, malicious, or pattern-based misuse of preemption remains chargeable under the higher offenses of this Act.
...
## Section 16 — Nullity of Government Instruments Repugnant to This Act or to Constitutional Authority

### 16.1 Repugnant Instruments Are Null and Void
...
### 16.1A Definitions and Examples
...
**Practical means of exercising a right** means the ordinary real-world access, movement, communication, process, tools, records, transportation, filing ability, property use, or other practical mechanism without which the protected right cannot meaningfully be used. A government instrument is repugnant where it recognizes a right in words but blocks the ordinary practical means needed to exercise that right, unless the restriction is supported by lawful constitutional authority and applied with logical consistency.
...
- A transportation rule that admits a citizen has the right to interstate travel, but makes ordinary use of public roads practically unavailable to the poor, disabled, rural, elderly, young, or working citizen who must use those roads to exercise the right
...
### 16.2 No Effect; No Reliance; No Liability for Refusal
...
- **A court** in any case where the instrument is at issue, applying the standard set out in Section 16.5
...
### 16.6 Citizen Council Authority Over Repugnant Instruments

A Citizen Council acting under Section 9 may, in addition to or in lieu of charging individual government actors:

- Issue a **Joint Declaration of Logical Consistency Review** under Section 9.14 nullifying a statute, regulation, or rule that is repugnant under this Section
- Issue a **Declaration of Production of Records** under Section 9.8 requiring production of records bearing on the issuance or enforcement of a repugnant instrument
- Issue a **Joint Declaration of Prosecution** under Section 9.3 against any government actor who issued, signed, or enforced the repugnant instrument

The full Council powers and protections of Section 9 — including no-judicial-gatekeeping (§9.4), mandatory prosecution (§9.5), no-interference (§9.9), and indictment effect upon filing (§9.11) — apply.
...
- Negligent breach: **infraction** under §3.3, with restitution and structural remedies; **Class 1 misdemeanor** where measurable harm results or the breach repeats after notice
...
### 17.2B Retaliatory Charge Fabrication
...
### 17.3 Reckless Rights Endangerment
...
- **Infraction** — administrative fine of up to one thousand dollars ($1,000)
- **Mandatory remedial constitutional training** as a condition of continued service
- **Repeat oath negligence** within twenty-four (24) months: **Class 1 misdemeanor** and ineligibility for office until satisfactory completion of remedial training and re-administration of the oath

### 17.8 Oath Verification Citation
...
### 17.9C Status-Based Survival Enforcement
...
- Where death, suicide, serious bodily injury, or life-threatening medical crisis results, the offense is a **capital offense**, and Section 11 applies where the elements are met
...
- Minor interference that does not stop recording, cause deletion, cause detention, or produce legal consequence is a **Class 1 misdemeanor**
...
### 17.9E Revenue Extraction Under Color of Law
...
### 17.9K Language-Access Obstruction
...
### 17.9L Victim-Service Abandonment
...
- Where death, serious injury, sexual assault, repeated victimization, or suicide results, the offense is a **capital offense**, and Section 11 applies where the elements are met

### 17.9M Juvenile Authority Abuse
...
- Where financial conflict of interest, quota, kickback, private-facility benefit, or coordinated scheme is involved, the offense is a **capital offense**

### 17.10 Abuse Under Color of Office
...
- The officer used the force with conscious disregard of that risk (per §3.2)
...
Legislators and legislative-body members are liable under this Act only where legislative authority is used, maintained, defended, funded, or enforced in a manner that is unconstitutional, repugnant, logically inconsistent, outside legitimate legislative power, corrupt, retaliatory, self-dealing, for personal gain, or contrary to this Act.

Election does not convert undefined power into lawful power. A legislator, council member, commissioner, mayor, governor, attorney general, or other elected official holds a defined office with defined duties, defined limits, and defined constitutional boundaries. The official's vote total, title, oath, public popularity, party support, or appearance of democratic legitimacy does not excuse a violation of protected rights and does not prevent criminal enforcement under this Act. A right that is protected by this Act is not merely advisory, aspirational, or dependent on the goodwill of elected officials; it is enforceable by civil action, Citizen Council process, and criminal prosecution where the elements of an offense are met.

Legislative authority, when used appropriately, is not an issue under this title. Legitimate legislative power remains lawful. A legislator does not violate this Act merely by voting for, debating, sponsoring, amending, or supporting legislation that is within constitutional authority, supported by a legitimate public purpose, and applied without violating protected rights, due process, logical consistency, or equal application of law. Ordinary policy disagreement, mistaken prediction, budget compromise, unpopular legislation, or a good-faith policy choice within lawful authority is not enough by itself to create liability.

The line is crossed when legislative power is used to create, preserve, or defend a legal situation that the legislative body had no constitutional authority to impose upon citizens, or when legislative authority is used as an instrument of private benefit, favoritism, retaliation, corruption, concealment, coercion, or personal gain. This includes legislation, ordinances, appropriations, enforcement schemes, fee structures, criminal penalties, regulatory conditions, or public-private arrangements that:

- Compel a citizen to surrender or violate a protected right as a condition of ordinary liberty
- Criminally punish a citizen for refusing a private contract, contract-like undertaking, financial pledge, property deposit, or other compelled obligation outside lawful constitutional authority
- Price poor, working, disabled, elderly, rural, young, or otherwise financially limited citizens out of movement, livelihood, court access, family access, public services, or ordinary participation in civil society
- Treat a statutory alternative as meaningful when that alternative is practically available only to citizens with wealth, credit, large deposits, institutional access, or specialized counsel
- Use police power, revenue power, licensing power, or regulatory power as a substitute for constitutional authority that does not actually exist
...
- Negligent failure: **infraction** under §3.3, with restitution; **Class 1 misdemeanor** where measurable harm results or the failure repeats after notice
- Reckless failure: **Class 1 misdemeanor** (Class 3 felony where the loss exceeds fifty thousand dollars ($50,000) or where loss recurs in a pattern)
- Intentional failure: **Class 3 felony**

### 17.19 Municipal Waste Misconduct
...
- **Class 2 felony**
- **Capital offense** where the concealed obligation exceeds one percent (1%) of the affected entity's annual budget, or where the concealment caused officials, oversight bodies, or voters to act on materially false information
- May be charged cumulatively with §17.6 (Public Trust Fraud) and §17.9 (Failure of Transparency)

### 17.21 Preferential Contracting Abuse
...
- Charge cumulatively under §17.4 (Deliberate Record Distortion), §17.6 (Public Trust Fraud), §17.9 (Failure of Transparency), §17.23 (Regulatory Weaponization), or any underlying offense
...
- Where the refusal is intentional, retaliatory, part of a cover-up, or allows death, serious bodily injury, sexual abuse, wrongful conviction, family separation, or a pattern of violations, the offense is a **capital offense**, and Section 11 applies where the elements are met

### 17.24C Local Governing-Body Retaliation
...
> A government actor commits **eminent-domain valuation manipulation** where the actor uses condemnation, threatened condemnation, zoning, code enforcement, blight designation, permit denial, public-project announcement, infrastructure withholding, access restriction, utility control, regulatory delay, tax assessment, nuisance designation, environmental designation, or other public power to depress, damage, freeze, burden, stigmatize, or devalue private property before taking or attempting to take that property by eminent domain.

The constitutional mandate of **just compensation** requires compensation based on the property's lawful value, not a value artificially lowered by government pressure. Government may not create the loss and then buy the land at the discounted price caused by its own conduct.

**Elements:**

- The actor is a government actor, public body, redevelopment authority, agency, contractor, consultant, appraiser, or intermediary acting under color of authority
- The actor participates in, prepares for, recommends, approves, funds, threatens, negotiates, appraises, or carries out condemnation, eminent domain, redevelopment acquisition, public-project acquisition, or forced transfer of private property
- Before or during the taking process, the actor uses or benefits from public power that depresses, burdens, freezes, stigmatizes, or reduces the apparent value, marketability, access, use, financing, insurability, occupancy, development potential, or bargaining position of the property
- The actor knew, or in reckless disregard of clear evidence should have known, that the government-created condition affected the property owner's ability to obtain just compensation

**Includes, Without Limitation:**

- Declaring, threatening to declare, or selectively treating property as blighted, unsafe, nonconforming, nuisance, abandoned, underused, environmentally impaired, or code-defective in order to reduce acquisition price
- Announcing a public project, route, redevelopment plan, zoning change, or condemnation target in a manner that freezes private buyers, financing, tenants, development, repairs, or ordinary market value, then using the depressed value as the basis for compensation
- Denying permits, utilities, access, inspections, repairs, occupancy approvals, rezoning, variances, business licenses, or ordinary government services to pressure the owner to sell
- Using code enforcement, fines, liens, tax assessments, demolition threats, police contact, regulatory inspections, or administrative delay to make continued ownership financially unbearable
- Condemning land because the owner refused the government's offered price, objected to the project, asserted constitutional rights, requested records, demanded an independent appraisal, criticized officials, assisted a Citizen Council, or refused political, financial, or personal support
- Coordinating with developers, donors, favored bidders, public-private partners, consultants, appraisers, or political allies to depress the property value before acquisition or to transfer the property after acquisition
- Relying on an appraisal, valuation, comparable sale, blight finding, market study, or administrative record that fails to remove the effect of government-created devaluation

**Just Compensation Rule:**

For purposes of this Act, just compensation must be determined without subtracting any loss in value caused by the government actor's own announcement, threat, delay, designation, enforcement, regulation, withholding of services, project planning, or condemnation activity. The owner is entitled to valuation as if the government-created burden, stigma, freeze, or coercive pressure had not occurred.

Refusal by the owner to accept the government's offered price, refusal to waive rights, refusal to sign a release, refusal to settle, refusal to consent to entry, or demand for constitutional just compensation is not a lawful basis for condemnation, retaliation, code enforcement, permit denial, valuation penalty, or adverse treatment.
...
- A claim that the testimony was given in another jurisdiction (e.g., Washington, D.C.) rather than within Utah is **not** a defense; the harm is to Utah's representation in Congress and therefore to Utah citizens, and this Act reaches that harm consistent with Section 16.7
...
- Where the obstruction is intentional, retaliatory, coordinated with the accused agency, or conceals official crime, public corruption, federal rights violations, death, serious injury, or sexual abuse, the offense is a **capital offense**

### 17.25B Federal-State Shielding Coordination
...
### 17.26 Penalty Structure (Cross-Reference)

The classifications above operate against the four-level mens rea framework of **Section 3** and the existing penalty classifications of this title. For convenience, the relationship between mental state and offense classification under this Section is summarized as follows:

| Mental State | Default Outcome Under This Section |
|---|---|
| **Negligence** (§3.1, §3.3) | Infraction by default, with restitution and structural remedies; Class 1 misdemeanor where measurable harm results, the conduct repeats after notice, or this Section expressly provides a higher classification |
| **Recklessness** (§3.1, §3.2) | Misdemeanor or felony as designated; default felony floor for substantive abuses of authority |
| **Intent** (§3.1, §3.4) | One-class elevation from the reckless baseline |
| **Malice** (§3.1, §3.5) | Maximum classification within the statutory range; capital offense where this Act authorizes capital treatment |
...
- Retaliation occurred (also independently chargeable under §17.2)
...
The following Supreme Court cases inform the definitions in **Section 1**, the immunity-abrogation provisions of **Section 5**, and the repugnancy and logical-consistency review in **Section 16**. Each entry provides the full citation, a brief statement of the holding, and the cross-reference to the definition or provision that relies on it.

---

**L.1 — *United States v. Classic*, 313 U.S. 299 (1941).**

The foundational definition of "color of law." The Court held that *"misuse of power, possessed by virtue of state law and made possible only because the wrongdoer is clothed with the authority of state law, is action taken 'under color of' state law."* This formulation has been carried into every subsequent color-of-law case. *Referenced in §1.1.1.5 (Color of Law).*

---

**L.2 — *Screws v. United States*, 325 U.S. 91 (1945).**

Applied *Classic*'s definition in the criminal civil-rights context (now codified at 18 U.S.C. § 242). The Court confirmed that a state law-enforcement officer who exceeded or violated state law in the course of an arrest still acted under color of law, because the officer's ability to act at all came from the office. *Referenced in §1.1.1.5 (Color of Law).*

---

**L.3 — *Monroe v. Pape*, 365 U.S. 167 (1961).**

Applied the color-of-law doctrine in the civil-rights context under 42 U.S.C. § 1983. The Court held that police officers acting within the scope of their authority — but in violation of state law — were still acting "under color of" state law. *"Misuse of power" by an officer is itself action taken under color of law, even where the conduct is not authorized by state law.* *Referenced in §1.1.1.5 (Color of Law).*

---

**L.4 — *Adickes v. S.H. Kress & Co.*, 398 U.S. 144 (1970).**

Extended the color-of-law inquiry to **private conduct that is fairly attributable to the state**. Conduct that would otherwise be private becomes state action — and thus action under color of law — when it is taken in concert with, or with the encouragement of, state actors. *Referenced in §1.1.1.5 (Color of Law).*

---

**L.5 — *Lugar v. Edmondson Oil Co.*, 457 U.S. 922 (1982).**

Set out a **two-part test** for whether private conduct is "under color of" state law: *(1)* the deprivation must result from the exercise of a right or privilege created by the state, by a state-imposed rule of conduct, or by a person for whom the state is responsible; and *(2)* the party charged with the deprivation must be a person who may fairly be said to be a state actor. *Referenced in §1.1.1.5 (Color of Law).*

---

**L.6 — *West v. Atkins*, 487 U.S. 42 (1988).**

Held that a **private physician** under contract with the state to provide medical care to prison inmates acted under color of state law. The case demonstrates that color-of-law liability can reach contractors, deputized private individuals, and others performing traditionally governmental functions — as reflected in the catch-all of Section 1.1.1 of this Act. *Referenced in §1.1.1.5 (Color of Law).*

---

**L.7 — *Bradley v. Fisher*, 80 U.S. (13 Wall.) 335 (1872).**

The foundational judicial-immunity case. Justice Field wrote that judges enjoy absolute civil immunity for judicial acts done within jurisdiction *"however erroneous the act may have been, and however injurious in its consequences it may have proved to the plaintiff."* Critically, the Court held that immunity is **not lost by allegations that the act was done maliciously or corruptly**. *Referenced in §1.1.1.6 (Judicial Immunity); abrogated by §5.1.1.*

---

**L.8 — *Pierson v. Ray*, 386 U.S. 547 (1967).**

Extended *Bradley* to civil rights actions under 42 U.S.C. § 1983. The Court held that judges retain absolute immunity from § 1983 suits even where the judge is accused of acting in **bad faith or with malice**, reasoning that § 1983 was not intended to abolish the long-established common-law doctrine of judicial immunity. *Referenced in §1.1.1.6 (Judicial Immunity); abrogated by §5.1.1.*

---

**L.9 — *Stump v. Sparkman*, 435 U.S. 349 (1978).**

A state judge approved, **without a hearing and without due process**, a parental petition to surgically sterilize a fifteen-year-old girl. The girl was told she was having an appendectomy. The Supreme Court held the judge was absolutely immune from § 1983 liability, reasoning that "grave procedural errors" do not strip judicial immunity if the act is "judicial in nature" and within the judge's general jurisdiction. The case is widely regarded as the most extreme application of the doctrine. *Referenced in §1.1.1.6 (Judicial Immunity); abrogated by §5.1.1.*

---

**L.10 — *Mireles v. Waco*, 502 U.S. 9 (1991).**

Per curiam. A judge allegedly **ordered police to forcibly bring a public defender to his courtroom "with excessive force."** The Court applied absolute judicial immunity, holding that the order to use force was "judicial in nature" because it concerned bringing a party before the court — and therefore was immune even though it allegedly directed unlawful violence against an attorney. *Referenced in §1.1.1.6 (Judicial Immunity); abrogated by §5.1.1.*

---

**L.11 — *Imbler v. Pachtman*, 424 U.S. 409 (1976).**

The foundational prosecutorial-immunity case. The Court held that prosecutors enjoy absolute civil immunity for acts intimately associated with the judicial phase of the criminal process — initiating prosecutions, presenting the state's case at trial — even where the prosecutor allegedly **knowingly used perjured testimony** and suppressed exculpatory evidence to obtain a conviction. *Referenced in §1.1.1.7 (Prosecutorial Immunity); abrogated by §5.1.1.*

---

**L.12 — *Burns v. Reed*, 500 U.S. 478 (1991).**

Refined *Imbler* by distinguishing between prosecutorial conduct in the "advocate" role (immune) and conduct as an investigator or legal advisor to police (not absolutely immune). *Referenced in §1.1.1.7 (Prosecutorial Immunity); abrogated by §5.1.1.*

---

**L.13 — *Buckley v. Fitzsimmons*, 509 U.S. 259 (1993).**

Continued the *Imbler* line; absolute immunity does not extend to a prosecutor's acts of investigation or fabrication of evidence prior to the existence of probable cause to arrest. *Referenced in §1.1.1.7 (Prosecutorial Immunity); abrogated by §5.1.1.*

---

**L.14 — *Van de Kamp v. Goldstein*, 555 U.S. 335 (2009).**

Extended absolute prosecutorial immunity to administrative supervision of office practices (such as failing to maintain a database of impeachment information about police informants), so long as the conduct is sufficiently "intimately associated with the judicial phase." *Referenced in §1.1.1.7 (Prosecutorial Immunity); abrogated by §5.1.1.*

---

**L.15 — *Harlow v. Fitzgerald*, 457 U.S. 800 (1982).**

The foundational case for the modern qualified-immunity doctrine. The Court replaced the older "subjective good faith" standard with an **objective "clearly established law"** test: officials are immune from civil liability *"insofar as their conduct does not violate clearly established statutory or constitutional rights of which a reasonable person would have known."* *Referenced in §1.1.1.8 (Qualified Immunity); abrogated by §5.1.1.*

---

**L.16 — *Anderson v. Creighton*, 483 U.S. 635 (1987).**

Refined *Harlow* by emphasizing that "clearly established" must be assessed at a relatively high level of factual specificity — not at a general level of abstraction. *Referenced in §1.1.1.8 (Qualified Immunity); abrogated by §5.1.1.*

---

**L.17 — *Saucier v. Katz*, 533 U.S. 194 (2001).**

Established a mandatory two-step sequence for qualified-immunity analysis: first determine whether a constitutional right was violated; then determine whether the right was clearly established. *Referenced in §1.1.1.8 (Qualified Immunity); abrogated by §5.1.1.*

---

**L.18 — *Pearson v. Callahan*, 555 U.S. 223 (2009).**

Modified *Saucier* by making the two-step sequence discretionary rather than mandatory. Courts may now resolve qualified-immunity claims solely on the "clearly established" prong without first deciding whether a constitutional right was violated. *Referenced in §1.1.1.8 (Qualified Immunity); abrogated by §5.1.1.*

---

**L.19 — *Allgeyer v. Louisiana*, 165 U.S. 578 (1897).**

Recognized that the Fourteenth Amendment's protection of liberty includes the citizen's right to pursue lawful life and work, and for that purpose to enter "all contracts" proper, necessary, and essential to carrying out those lawful purposes. The case arose from a Louisiana insurance statute and is referenced in §16.1A as a contract-liberty authority.

---

**L.20 — *Lochner v. New York*, 198 U.S. 45 (1905).**

Recognized the general right to make a contract in relation to one's business as part of liberty protected by the Fourteenth Amendment, while allowing regulation within the legitimate exercise of police power. Referenced in §16.1A as a contract-liberty authority.

---

**L.21 — *Adair v. United States*, 208 U.S. 161 (1908).**

Recognized liberty and property interests in the right to make lawful contracts, including employment contracts, and treated arbitrary interference with such contracts as a constitutional injury. The Court stated that government may not, absent contract, compel a person against the person's will to employ or be employed by another. Referenced in §16.1A as a contract-liberty authority.

---

**L.22 — *Coppage v. Kansas*, 236 U.S. 1 (1915).**

Recognized the "right to make contracts" for acquisition of property as part of personal liberty and private property, with employment agreements identified as a chief example. Referenced in §16.1A as a contract-liberty authority.

---

**L.23 — *Nebbia v. New York*, 291 U.S. 502 (1934).**

Recognized broad state power to regulate economic matters in the public interest where the regulation is not arbitrary, discriminatory, or demonstrably irrelevant to policy within legislative authority. Referenced in §16.1A as a limiting authority that must be applied with logical consistency.

---

**L.24 — *West Coast Hotel Co. v. Parrish*, 300 U.S. 379 (1937).**

Held that freedom of contract is subject to reasonable regulation in the community interest and upheld a minimum-wage law against a due-process challenge. Referenced in §16.1A as a limiting authority that must be applied with logical consistency.

---

**L.25 — Thirteenth Amendment to the Constitution of the United States (ratified 1865).**

Prohibits slavery and involuntary servitude within the United States, except as punishment for a crime after due conviction. Referenced in §16.1A as constitutional authority against compelled private-contract servitude.

---

**L.26 — *Bailey v. Alabama*, 219 U.S. 219 (1911).**

Invalidated a state criminal-law device that punished breach of a labor obligation in a manner that coerced performance of private service. Referenced in §16.1A as anti-peonage authority against using criminal law to force private obligation.

---

**L.27 — *Pollock v. Williams*, 322 U.S. 4 (1944).**

Reaffirmed that criminal law may not be used to coerce a person into service or performance of a private obligation through debt or contract pressure. Referenced in §16.1A as anti-peonage authority against compelled private-contract servitude.

---

**L.28 — *Crandall v. Nevada*, 73 U.S. (6 Wall.) 35 (1868).**

Invalidated a Nevada tax imposed on persons leaving the state by railroad, stage coach, or other ordinary passenger transportation. The Court treated the tax as a burden on the right of transit through the states and warned that if a state could impose one dollar, it could impose one thousand and seriously burden travel. Referenced in §16.1A as authority against pricing citizens out of ordinary movement.

---

**L.29 — *Edwards v. California*, 314 U.S. 160 (1941).**

Invalidated a California law making it a misdemeanor to bring or assist an indigent nonresident into the state. Referenced in §16.1A as authority against criminalizing travel, assistance, or movement because of poverty.

---

**L.30 — *Shapiro v. Thompson*, 394 U.S. 618 (1969).**

Recognized the constitutional right to interstate travel as fundamental and invalidated durational-residency rules that penalized needy persons for moving between states. Referenced in §16.1A as right-to-travel authority.

---

**L.31 — *Saenz v. Roe*, 526 U.S. 489 (1999).**

Explained that the constitutional right to travel includes the right to enter and leave another state, to be treated as a welcome visitor, and to become a citizen of a new state on equal terms. Referenced in §16.1A as modern right-to-travel authority.

---

**L.32 — *Harper v. Virginia Board of Elections*, 383 U.S. 663 (1966).**

Held that wealth or payment of a fee may not be used as a condition on the exercise of a fundamental civic right, and that wealth classifications burdening such rights are constitutionally disfavored. Referenced in §16.1A as wealth-barrier authority.

---

**L.33 — *Griffin v. Illinois*, 351 U.S. 12 (1956).**

Held that a state may not administer criminal appellate review in a way that effectively denies poor defendants access available to those who can pay. Referenced in §16.1A as authority against making legal protection turn on poverty.
...
**In the body of the email, please include your first name and zip code:**
...
> By submitting your **first name** and **zip code** by email to the address above with the subject line `CHECKMATE`, you are providing a form of **electronic signature** in support of this petition. Your submission affirms that you are a real person who supports the principles of Operation Checkmate as set out in the Statement of Intent and the substantive provisions of this Act.

**Privacy:** Your name and zip code are collected solely to demonstrate citizen support for this proposal. Aggregated counts (by zip code, county, or state) may be shared publicly. **Your full identity will not be published** without your separate, explicit consent.

**Questions, edits, or feedback** on the draft are welcome at the same address — please use the same subject line `CHECKMATE` so that supporting messages and feedback are collected in one place.
